---
type: "Source"
id: "src-geumseok-gskh_008_0020_0010"
label: "순장군 공덕기"
labelHanja: "珣將軍 功德記"
sourceKind: "금석문"
...
sourceLevelId: "gskh_008_0020_0010"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_008_0020_0010`. 경로: 백제 유민 관련 금석문 › 비문 › 순장군 공덕기.
...
XML 날짜: `0707-99-99` — 707년 (당 중종 경룡 원년).
...
출토·소재지 원표기: 중국 샨시성(山西省) 타이위안시(太原市) 천룡산문물관리소(天龍山文物管理所). 소장처: 중국 샨시성 타이위안시 천룡산석굴(天龍山石窟).
크기: 너비 64cm, 높이 96cm. 서체: 예서 / 해서(제액).
[국편 항목](https://db.history.go.kr/id/gskh_008_0020_0010)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 5,266.
주석 51(각주 51), 색인어 0().
<!-- counts:end -->
