---
type: "Source"
id: "src-geumseok-gskh_007_0010_0140"
label: "고흠덕 묘지명"
labelHanja: "高欽德 墓誌銘"
sourceKind: "금석문"
...
sourceLevelId: "gskh_007_0010_0140"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_007_0010_0140`. 경로: 고구려 유민 관련 금석문 › 묘지명 › 고흠덕 묘지명.
...
XML 날짜: `0733-09-19` — 사망일 : 733년(당 開元 21년) 9월 19일; 장례일 : 746년(병술년) 또는 750년(경인년).
...
출토·소재지 원표기: 中國 江蘇省 南京市 南京博物院. 소장처: 中國 河南省 洛陽市(전언).
크기: 지석(誌石) : 정방형, 한 변 54.5㎝; 개석(蓋石)의 존부 미확인. 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_007_0010_0140)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 5,201.
주석 11(각주 11), 색인어 0().
<!-- counts:end -->
