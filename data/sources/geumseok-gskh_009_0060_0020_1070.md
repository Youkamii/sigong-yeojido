---
type: "Source"
id: "src-geumseok-gskh_009_0060_0020_1070"
label: "태강4년명 전(2)"
labelHanja: "太康四年銘 塼(2)"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
composedYear: 283
coversFrom: 283
...
sourceLevelId: "gskh_009_0060_0020_1070"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0060_0020_1070`. 경로: 낙랑 › 와명·전명·토기명 › 전명 › 태강4년명 전(2).
...
XML 날짜: `0283-99-99` — 283년(진(晉) 무제(武帝) 태강(太康)4년).
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 황해남도(구 황해도) 신천군(信川郡) 북부면(北部面) 서호리(西湖里).
크기: 없음. 서체: 예서체(隷書體) / 흙.
[국편 항목](https://db.history.go.kr/id/gskh_009_0060_0020_1070)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,676.
주석 1(각주 1), 색인어 2(지명 1 · 이름 1).
<!-- counts:end -->
