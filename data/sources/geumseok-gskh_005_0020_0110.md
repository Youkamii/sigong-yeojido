---
type: "Source"
id: "src-geumseok-gskh_005_0020_0110"
label: "창녕 관룡사 용선대 석조여래좌상 조성기"
labelHanja: "昌寧 觀龍寺 龍船臺 石造如來坐像 造成記"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0020_0110"
defaultLens: false
license: "open"
...
# 창녕 관룡사 용선대 석조여래좌상 조성기

국편 한국고대금석문 벌크의 `gskh_005_0020_0110`. 경로: 통일신라 › 불상명 › 창녕 관룡사 용선대 석조여래좌상 조성기.
...
XML 날짜: `0722-99-99` — 722년(신라 성덕왕 21)~731년(신라 성덕왕 30).
...
출토·소재지 원표기: 경상남도 창녕군 창녕읍 화왕산관룡사길 171, 관룡사 (옥천리). 소장처: 없음.
크기: (대좌) 높이 117㎝. 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_005_0020_0110)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,331.
주석 3(각주 3), 색인어 0().
<!-- counts:end -->
