---
type: "Source"
id: "src-geumseok-gskh_010_0010_0010"
label: "김천 당 시장군 정사초당비"
labelHanja: "金泉 唐 柴將軍 精舍草堂碑"
sourceKind: "금석문"
sourceGroup: "금석문 · 중국계 금석문"
composedYear: 661
coversFrom: 661
coversTo: 661
originalLanguage: "mixed"
sourceLevelId: "gskh_010_0010_0010"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_010_0010_0010`. 경로: 중국계 금석문 › 비문 › 김천 당 시장군 정사초당비.
...
XML 날짜: `0661-99-99` — 661년(태종 무열왕 8)~668년(문무왕 8).
...
출토·소재지 원표기: 경상북도 김천시 대항면 직지사길 95, 직지성보박물관. 소장처: 경상북도 김천시 남면 월명리 230-1, 미륵암 내 관음전.
크기: 높이 58cm, 너비 41cm. 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_010_0010_0010)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 4,684.
주석 78(각주 78), 색인어 0().
<!-- counts:end -->
