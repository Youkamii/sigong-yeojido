---
type: "Source"
id: "src-geumseok-gskh_007_0010_0200"
label: "천남산 묘지명"
labelHanja: "泉男産 墓誌銘"
sourceKind: "금석문"
...
sourceLevelId: "gskh_007_0010_0200"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_007_0010_0200`. 경로: 고구려 유민 관련 금석문 › 묘지명 › 천남산 묘지명.
...
XML 날짜: `0702-99-99` — 702년(武周 長安 2년).
...
출토·소재지 원표기: 북경대학(北京大學) 새극륵고고여예술박물관(賽克勒考古與藝術博物館). 소장처: 하남성(河南省) 낙양시(洛陽市) 맹진현(孟津縣).
크기: 지석: 가로·세로 각각 75㎝×75㎝, 개석: 가로·세로 각각 76㎝×76㎝. 서체: 楷書.
[국편 항목](https://db.history.go.kr/id/gskh_007_0010_0200)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 6,662.
주석 43(각주 43), 색인어 0().
<!-- counts:end -->
