---
type: "Source"
id: "src-geumseok-gskh_005_0020_0130"
label: "칠월삼일명 석불좌상"
labelHanja: "七月三日銘 石佛坐像"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0020_0130"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0020_0130`. 경로: 통일신라 › 불상명 › 칠월삼일명 석불좌상.
...
출토·소재지 원표기: 경상북도 경주시 일정로 186 국립경주박물관. 소장처: 경상북도 경주시 분황로 94-11 분황사.
크기: 높이 63㎝, 폭 80㎝. 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_005_0020_0130)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,047.
주석 0(), 색인어 0().
<!-- counts:end -->
