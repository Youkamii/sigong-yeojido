---
type: "Source"
id: "src-geumseok-gskh_001_0060_0010_0050"
label: "「십곡민조」명 와당"
labelHanja: "「十谷民造」銘 瓦壋"
sourceKind: "금석문"
sourceGroup: "금석문 · 고구려"
composedYear: 338
coversFrom: 338
...
sourceLevelId: "gskh_001_0060_0010_0050"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_001_0060_0010_0050`. 경로: 고구려 › 와명·전명 › 중국 집안지역 출토 와명 › 「십곡민조」명 와당.
...
XML 날짜: `0338-99-99` — 故國原王 八年(三三八) 推定.
...
출토·소재지 원표기: 中國 吉林省 集安縣 梨樹園子南遺址(現 遼寧省博物館藏). 소장처: 없음.
크기: 半俓7.5cm、厚2.3cm. 서체: 隷書.
[국편 항목](https://db.history.go.kr/id/gskh_001_0060_0010_0050)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 4. 연대(dateOccured) 붙은 chunk 2, 본문이 빈 chunk 0, 본문 글자 수 325.
주석 0(), 색인어 0().
<!-- counts:end -->
