...
국사편찬위원회 실록원문 벌크 XML(2022-11-03)의 `wia` 계열 파일을 모은 판본이다.
원문 사료와 수정·보완본을 별도 Source로 둔다. 원문을 합치거나 옳고 그름을 정하지 않는다.

## 연도 근거

[국가기록원 실록 일람표](https://theme.archives.go.kr/next/sillok/sub2_2.do)의 수록 기간 1469~1494, 편찬 연도 1499를 따른다.
...
chunk 가 놓인 층: level2 28 · level3 316 · level5 32,438. 연대(dateOccured) 붙은 chunk 32,464, 본문이 빈 chunk 0, 본문 글자 수 5,699,787.
주석 3,379(교감주 3,063 · 원주 316), 색인어 202,679(이름 151,275 · 지명 44,692 · 서명 5,985 · 연호 727).
<!-- counts:end -->

숫자는 `scripts/fill_card_counts.py --source sillok-wia`와 같은 코드로 센다.
