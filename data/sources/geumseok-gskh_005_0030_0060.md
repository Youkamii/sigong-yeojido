---
type: "Source"
id: "src-geumseok-gskh_005_0030_0060"
label: "「김가기전」 마애석각"
labelHanja: "「金可記傳」 磨崖石刻"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0030_0060"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0030_0060`. 경로: 통일신라 › 석각 › 「김가기전」 마애석각.
...
출토·소재지 원표기: 中國 陝西省 西安市 長安區 長安博物館. 소장처: 中國 陝西省 西安市 終南山 子午谷口.
크기: (바위) 높이 400㎝, 너비 300㎝ (각자부분) 높이 200㎝, 너비 190㎝. 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_005_0030_0060)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 2,167.
주석 18(각주 18), 색인어 0().
<!-- counts:end -->
