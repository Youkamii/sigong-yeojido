---
type: "Source"
id: "src-geumseok-gskh_010_0010_0040"
label: "관구검기공비"
labelHanja: "毌丘儉紀功碑"
sourceKind: "금석문"
...
sourceLevelId: "gskh_010_0010_0040"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_010_0010_0040`. 경로: 중국계 금석문 › 비문 › 관구검기공비.
...
XML 날짜: `0245-05-99` — 245년 5월·정시(正始) 6년 5월.
...
출토·소재지 원표기: 중국 랴오닝성(遼寜省) 선양시(瀋陽市) 랴오닝성박물관. 소장처: 지린성(吉林省) 지안시(集安市) 환도산성(丸都山城) 서북쪽 판석령(板石嶺) 부근.
크기: 높이 39cm, 넓이 30cm, 두께 8~8.5cm. 서체: 예서(隸書).
[국편 항목](https://db.history.go.kr/id/gskh_010_0010_0040)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 2,872.
주석 24(각주 24), 색인어 0().
<!-- counts:end -->
