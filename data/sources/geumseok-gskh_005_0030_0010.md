---
type: "Source"
id: "src-geumseok-gskh_005_0030_0010"
label: "건령2년명 석각"
labelHanja: "乾寧二年銘 石刻"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0030_0010"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0030_0010`. 경로: 통일신라 › 석각 › 건령2년명 석각.
...
출토·소재지 원표기: 경상북도 경주시 일정로 186 (인왕동, 국립경주박물관). 소장처: 경상북도 경주시 보문동 56 명활성.
크기: 비석 전체 : 길이 21.0㎝, 너비 10.0㎝，두께 5.8㎝.. 서체: 해서체(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_005_0030_0010)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,348.
주석 3(각주 3), 색인어 0().
<!-- counts:end -->
