---
type: "Source"
id: "src-geumseok-gskh_003_0020_0040"
label: "「술랑」 제명 석각"
labelHanja: "「述郞」 題名 石刻"
sourceKind: "금석문"
sourceGroup: "금석문 · 신라"
...
sourceLevelId: "gskh_003_0020_0040"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_003_0020_0040`. 경로: 신라 › 석각 › 「술랑」 제명 석각.
...
출토·소재지 원표기: 강원도 고성군(高城郡) 삼일포(三日浦). 소장처: 강원도 고성군 삼일포.
크기: 높이 56cm, 너비 30.3cm. 서체: 정서(正書) / 돌.
[국편 항목](https://db.history.go.kr/id/gskh_003_0020_0040)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 2, 본문이 빈 chunk 0, 본문 글자 수 271.
주석 0(), 색인어 2(이름 2).
<!-- counts:end -->
