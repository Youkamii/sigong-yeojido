---
type: "Source"
id: "src-geumseok-gskh_005_0010_0250"
label: "장흥 보림사 보조선사탑비"
labelHanja: "長興 寶林寺 普照禪師塔碑"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0010_0250"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0010_0250`. 경로: 통일신라 › 비문 › 장흥 보림사 보조선사탑비.
...
XML 날짜: `0884-99-99` — 884년(신라 헌강왕 10).
...
출토·소재지 원표기: 전라남도 장흥군 유치면 봉덕리 산10-1번지 보림사. 소장처: 없음.
크기: 높이 3.46m. 서체: 구양순체 해서 / 왕희지체 행서.
[국편 항목](https://db.history.go.kr/id/gskh_005_0010_0250)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 12,631.
주석 177(각주 156 · 소자쌍행 21), 색인어 0().
<!-- counts:end -->
