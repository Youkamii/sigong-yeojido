---
type: "Source"
id: "src-geumseok-gskh_001_0060_0010_0090"
label: "「기축」명 와당"
labelHanja: "「己丑」銘 瓦當"
sourceKind: "금석문"
sourceGroup: "금석문 · 고구려"
...
sourceLevelId: "gskh_001_0060_0010_0090"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_001_0060_0010_0090`. 경로: 고구려 › 와명·전명 › 중국 집안지역 출토 와명 › 「기축」명 와당.
...
XML 날짜: `0329-99-99` — 329년(미천왕30년) 추정.
...
출토·소재지 원표기: 중국 집안시박물관. 소장처: 중국 길림성(吉林省) 집안시(集安市 : 구 집안현) 마선중학(麻線中學) 서쪽 50m 지점.
크기: 직경 15cm. 서체: 미상 / 흙.
[국편 항목](https://db.history.go.kr/id/gskh_001_0060_0010_0090)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 218.
주석 0(), 색인어 0().
<!-- counts:end -->
