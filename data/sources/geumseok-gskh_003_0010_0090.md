---
type: "Source"
id: "src-geumseok-gskh_003_0010_0090"
label: "서울 북한산 신라 진흥왕 순수비"
labelHanja: "서울 北漢山 新羅 眞興王 巡狩碑"
sourceKind: "금석문"
sourceGroup: "금석문 · 신라"
composedYear: 568
coversFrom: 568
...
sourceLevelId: "gskh_003_0010_0090"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_003_0010_0090`. 경로: 신라 › 비문 › 서울 북한산 신라 진흥왕 순수비.
...
XML 날짜: `0568-99-99` — 568년(진흥왕 29) 추정.
...
출토·소재지 원표기: 서울 용산구 서빙고로 137, 국립중앙박물관 (용산동6가). 소장처: 서울 종로구 구기동 북한산 비봉 정상.
크기: 높이 154.0㎝, 너비 69.0㎝, 두께 16.6㎝. 서체: 해서체.
[국편 항목](https://db.history.go.kr/id/gskh_003_0010_0090)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 4,352.
주석 126(각주 126), 색인어 0().
<!-- counts:end -->
