...
국사편찬위원회 실록원문 벌크 XML(2022-11-03)의 `wea` 계열 파일을 모은 판본이다.
원문 사료와 수정·보완본을 별도 Source로 둔다. 원문을 합치거나 옳고 그름을 정하지 않는다.

## 연도 근거

[국가기록원 실록 일람표](https://theme.archives.go.kr/next/sillok/sub2_2.do)의 수록 기간 1450~1452, 편찬 연도 1455를 따른다.
...
chunk 가 놓인 층: level2 5 · level3 27 · level5 2,670. 연대(dateOccured) 붙은 chunk 2,673, 본문이 빈 chunk 0, 본문 글자 수 556,018.
주석 394(원주 208 · 교감주 186), 색인어 15,859(이름 9,468 · 지명 5,920 · 서명 398 · 연호 73).
<!-- counts:end -->

숫자는 `scripts/fill_card_counts.py --source sillok-wea`와 같은 코드로 센다.
