---
type: "Source"
id: "src-geumseok-gskh_006_0040_0020"
label: "일본 헤이조궁 출토 목간"
labelHanja: "日本 平城宮 出土 木簡"
sourceKind: "금석문"
sourceGroup: "금석문 · 발해"
composedYear: 727
coversFrom: 727
...
sourceLevelId: "gskh_006_0040_0020"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_006_0040_0020`. 경로: 발해 › 목간 › 일본 헤이조궁 출토 목간.
...
XML 날짜: `0727-99-99` — 日本 神龜四年(七二七) 추정.
...
출토·소재지 원표기: 平城宮 東二坊 坊間路 西側溝. 소장처: 없음.
크기: 現長8cm、幅8.5cm、두께 0.7cm. 서체: 없음.
[국편 항목](https://db.history.go.kr/id/gskh_006_0040_0020)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 2,073.
주석 0(), 색인어 1(관직 1).
<!-- counts:end -->
