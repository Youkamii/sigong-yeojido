---
type: "Source"
id: "src-jipseong-ko_083"
label: "玄奘三藏師資傳叢書"
labelHanja: "玄奘三藏師資傳叢書"
sourceKind: "사료집성 발췌"
...
국편 한국고대사료집성 중국편에 실린 『玄奘三藏師資傳叢書』의 한국사 관련 발췌다.
사서 전체 원문을 수록한 것으로 표시하지 않는다. 국편 사서 id `ko_083`를 Source 이름에 쓴다.
같은 한글 이름을 가진 다른 사서도 id가 달라 합쳐지지 않는다.

## 연도 근거와 한계

편찬 시점은 XML의 `source/dateIssued`에서 단일 연도나 정확한 날짜를 옮긴 값이다. 원표기: `19세기말`.
...
이 범위는 사서 전체의 범위나 인물의 생몰년이 아니다. 저자 원표기 `좌백정윤(佐伯定胤)`도 XML의 서지 정보로만 보존한다.
표제는 `mainTitle`을 쓴다. 설명 요소의 name 속성에는 다른 책 이름을 복사한 흔적이 있어 표제로 쓰지 않는다.

## 국편 서지 설명

『玄奘三藏師資傳叢書』는 중국 法相宗의 始祖가 되는 玄奘三藏(600-664)과 그 문하의 窺基, 圓測, 恵沼 등의 行狀과 塔銘, 碑文, 画讃 그리고 그들과 관련된 表啓文 등을 모은 것으로 19세기말에 일본인 佐伯定胤과 中野達慧이 2권으로 편찬하였다. 신라 출신인 원측은 현장삼장의 초기 제자 중 대표적인 인물로서 중국 법상종의 이론 체계를 수립하는데 중요한 역할을 담당하였는데, 唐나라 때의 문인 宋復이 그의 행적을 정리한 「大周西明寺故大徳圓測法師舎利塔銘并序」는 이 책의 下卷에 실려 있다.
...
chunk 가 놓인 층: level3 1. 연대(dateOccured) 붙은 chunk 0, 본문이 빈 chunk 0, 본문 글자 수 998.
주석 1(원주 1), 색인어 63(지명 22 · 이름 19 · 서명 18 · 연호 3 · 국명 1).
<!-- counts:end -->
