---
type: "Source"
id: "src-geumseok-gskh_005_0050_0020"
label: "(당고)김씨부인 묘지명"
labelHanja: "(唐故)金氏夫人 墓誌銘"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0050_0020"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0050_0020`. 경로: 통일신라 › 묘지명 › (당고)김씨부인 묘지명.
...
XML 날짜: `0864-99-99` — 864년(唐 咸通 5년).
...
출토·소재지 원표기: 中國 西安 碑林博物館. 소장처: 中國 陝西省 西安市 郭家灘.
크기: (개석) 가로 43.4cm, 세로 44cm; (지석) 가로 46.5cm, 세로 45.5cm. 서체: (개석) 전서체; (지석) 예서체.
[국편 항목](https://db.history.go.kr/id/gskh_005_0050_0020)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 6,435.
주석 66(각주 66), 색인어 0().
<!-- counts:end -->
