...
국사편찬위원회 실록원문 벌크 XML(2022-11-03)의 `wha` 계열 파일을 모은 판본이다.
원문 사료와 수정·보완본을 별도 Source로 둔다. 원문을 합치거나 옳고 그름을 정하지 않는다.

## 연도 근거

[국가기록원 실록 일람표](https://theme.archives.go.kr/next/sillok/sub2_2.do)의 수록 기간 1468~1469, 편찬 연도 1472를 따른다.
...
chunk 가 놓인 층: level2 4 · level3 19 · level5 1,501. 연대(dateOccured) 붙은 chunk 1,503, 본문이 빈 chunk 0, 본문 글자 수 323,067.
주석 417(원주 354 · 교감주 63), 색인어 13,608(이름 10,702 · 지명 2,683 · 서명 175 · 연호 48).
<!-- counts:end -->

숫자는 `scripts/fill_card_counts.py --source sillok-wha`와 같은 코드로 센다.
