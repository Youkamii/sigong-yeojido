---
type: "Source"
id: "src-geumseok-gskh_009_0020_0050_0040"
label: "상방작명 사신경(3)"
labelHanja: "上方作銘 四神鏡(3)"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
composedYear: null
coversFrom: null
...
sourceLevelId: "gskh_009_0020_0050_0040"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0020_0050_0040`. 경로: 낙랑 › 동경명 › 방격규구사신경(35) › 상방작명 사신경(3).
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 평안남도 평원군 평원면(구 대동군(大同郡) 대동강면(大同江面)) 석암리(石巖里) 등 낙랑지역.
크기: 없음. 서체: 동.
[국편 항목](https://db.history.go.kr/id/gskh_009_0020_0050_0040)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 177.
주석 0(), 색인어 1(관서 1).
<!-- counts:end -->
