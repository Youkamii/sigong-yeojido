---
type: "Source"
id: "src-geumseok-gskh_001_0030_0010"
label: "농오리산성 마애석각"
labelHanja: "籠吾里山城 磨崖石刻"
sourceKind: "금석문"
sourceGroup: "금석문 · 고구려"
composedYear: 555
coversFrom: 555
...
sourceLevelId: "gskh_001_0030_0010"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_001_0030_0010`. 경로: 고구려 › 석각 › 농오리산성 마애석각.
...
XML 날짜: `0555-99-99` — 陽原王 十一年(五五五) 推定.
...
출토·소재지 원표기: 平安北道 泰川郡 龍詳里. 소장처: 없음.
크기: 70×50cm(바위면). 서체: 楷書.
[국편 항목](https://db.history.go.kr/id/gskh_001_0030_0010)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 8. 연대(dateOccured) 붙은 chunk 5, 본문이 빈 chunk 0, 본문 글자 수 2,936.
주석 5(각주 5), 색인어 10(관직 5 · 이름 5).
<!-- counts:end -->
