---
type: "Source"
id: "src-geumseok-gskh_003_0010_0150"
label: "포항 중성리 신라비"
labelHanja: "浦項 中城里 新羅碑"
sourceKind: "금석문"
sourceGroup: "금석문 · 신라"
composedYear: 441
coversFrom: 441
...
sourceLevelId: "gskh_003_0010_0150"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_003_0010_0150`. 경로: 신라 › 비문 › 포항 중성리 신라비.
...
XML 날짜: `0441-99-99` — 501년(지증왕 2) 혹은 441년(눌지마립간 25).
...
출토·소재지 원표기: 경상북도 경주시 불국로 132 (마동, 국립경주문화재연구소). 소장처: 경상북도 포항시 북구 흥해읍 중성리 167-1.
크기: 높이 105.6㎝, 너비 47.6~49.4㎝, 두께 13.8~14.7㎝. 서체: 예서(隷書).
[국편 항목](https://db.history.go.kr/id/gskh_003_0010_0150)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 5,847.
주석 24(각주 24), 색인어 0().
<!-- counts:end -->
