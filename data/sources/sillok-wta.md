...
국사편찬위원회 실록원문 벌크 XML(2022-11-03)의 `wta` 계열 파일을 모은 판본이다.
원문 사료와 수정·보완본을 별도 Source로 둔다. 원문을 합치거나 옳고 그름을 정하지 않는다.

## 연도 근거

[국가기록원 실록 일람표](https://theme.archives.go.kr/next/sillok/sub2_2.do)의 수록 기간 1720~1724, 편찬 연도 1732를 따른다.
...
chunk 가 놓인 층: level2 6 · level3 58 · level5 2,740. 연대(dateOccured) 붙은 chunk 2,745, 본문이 빈 chunk 0, 본문 글자 수 488,916.
주석 340(원주 253 · 교감주 87), 색인어 16,861(이름 14,467 · 지명 2,211 · 서명 159 · 연호 24).
<!-- counts:end -->

숫자는 `scripts/fill_card_counts.py --source sillok-wta`와 같은 코드로 센다.
