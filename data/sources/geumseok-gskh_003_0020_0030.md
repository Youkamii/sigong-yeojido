---
type: "Source"
id: "src-geumseok-gskh_003_0020_0030"
label: "「수력지」명 각석편"
labelHanja: "「首力知」銘 刻石片"
sourceKind: "금석문"
sourceGroup: "금석문 · 신라"
composedYear: null
coversFrom: null
...
sourceLevelId: "gskh_003_0020_0030"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_003_0020_0030`. 경로: 신라 › 석각 › 「수력지」명 각석편.
...
출토·소재지 원표기: 月城과 雁鴨池 사이 道路에서 出土. 소장처: 없음.
크기: 길이 31cm、폭 9cm、글자크기 2~3cm. 서체: 楷書.
[국편 항목](https://db.history.go.kr/id/gskh_003_0020_0030)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 5. 연대(dateOccured) 붙은 chunk 3, 본문이 빈 chunk 0, 본문 글자 수 321.
주석 2(각주 2), 색인어 3(관직 2 · 이름 1).
<!-- counts:end -->
