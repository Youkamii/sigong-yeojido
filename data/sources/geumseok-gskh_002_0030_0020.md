---
type: "Source"
id: "src-geumseok-gskh_002_0030_0020"
label: "부여 북나성 출토 명문석"
labelHanja: "扶餘 北羅城 出土 銘文石"
sourceKind: "금석문"
sourceGroup: "금석문 · 백제"
composedYear: null
coversFrom: null
...
sourceLevelId: "gskh_002_0030_0020"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_002_0030_0020`. 경로: 백제 › 석각 › 부여 북나성 출토 명문석.
...
출토·소재지 원표기: 충남 부여군 부여읍 쌍북리 6번지 부여 청산성. 소장처: 없음.
크기: 길이 53㎝, 너비 26㎝, 두께 10㎝. 서체: 예서(隷書).
[국편 항목](https://db.history.go.kr/id/gskh_002_0030_0020)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,162.
주석 0(), 색인어 0().
<!-- counts:end -->
