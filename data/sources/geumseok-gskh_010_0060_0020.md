---
type: "Source"
id: "src-geumseok-gskh_010_0060_0020"
label: "「진고구려솔선천장」명 동인"
labelHanja: "「晉高句麗率善仟長」銘 銅印"
sourceKind: "금석문"
...
sourceLevelId: "gskh_010_0060_0020"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_010_0060_0020`. 경로: 중국계 금석문 › 인장명 › 「진고구려솔선천장」명 동인.
...
출토·소재지 원표기: 중국 천진예술박물관(天津藝術博物館) 1점, 소재지 미상 2점. 소장처: 지린성(吉林省) 지안시(集安市) 출토 추정.
크기: 가로 2.2cm, 세로 2.2cm, 두께 0.7cm. 서체: 전서(篆書).
[국편 항목](https://db.history.go.kr/id/gskh_010_0060_0020)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,345.
주석 8(각주 8), 색인어 0().
<!-- counts:end -->
