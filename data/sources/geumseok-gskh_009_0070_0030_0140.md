---
type: "Source"
id: "src-geumseok-gskh_009_0070_0030_0140"
label: "장진리 30호분 출토 칠기 명문"
labelHanja: "將進里 30號墳 出土 漆器 銘文"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
composedYear: null
coversFrom: null
...
sourceLevelId: "gskh_009_0070_0030_0140"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0070_0030_0140`. 경로: 낙랑 › 칠기명 › 명문 칠기 › 장진리 30호분 출토 칠기 명문.
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 평양시 력포구역(力浦區域) 장진동(將進洞) 장진리(將進里) 30호분.
크기: 미상(未詳). 서체: 나무.
[국편 항목](https://db.history.go.kr/id/gskh_009_0070_0030_0140)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,062.
주석 2(각주 2), 색인어 3(이름 2 · 관서 1).
<!-- counts:end -->
