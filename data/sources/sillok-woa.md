...
국사편찬위원회 실록원문 벌크 XML(2022-11-03)의 `woa` 계열 파일을 모은 판본이다.
원문 사료와 수정·보완본을 별도 Source로 둔다. 원문을 합치거나 옳고 그름을 정하지 않는다.

## 연도 근거

[국가기록원 실록 일람표](https://theme.archives.go.kr/next/sillok/sub2_2.do)의 수록 기간 1608~1623, 편찬 연도 1633를 따른다.
...
chunk 가 놓인 층: level2 16 · level3 187 · level5 22,121. 연대(dateOccured) 붙은 chunk 22,137, 본문이 빈 chunk 0, 본문 글자 수 3,831,103.
주석 834(교감주 834), 색인어 98,634(이름 76,112 · 지명 20,932 · 서명 1,417 · 연호 173).
<!-- counts:end -->

숫자는 `scripts/fill_card_counts.py --source sillok-woa`와 같은 코드로 센다.
