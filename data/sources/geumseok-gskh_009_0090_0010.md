---
type: "Source"
id: "src-geumseok-gskh_009_0090_0010"
label: "채협총 출토 목찰"
labelHanja: "彩篋塚 出土 木札"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
composedYear: null
coversFrom: null
...
sourceLevelId: "gskh_009_0090_0010"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0090_0010`. 경로: 낙랑 › 기타 › 채협총 출토 목찰.
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 평안남도 대동군(大同郡) 남곶면(南串面) 남정리(南井里) 116호분(채협총(彩篋塚)).
크기: 길이 23.7cm, 넓이 7.2cm, 두께 0.6cm. 서체: 나무.
[국편 항목](https://db.history.go.kr/id/gskh_009_0090_0010)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 469.
주석 2(각주 2), 색인어 2(관직 1 · 이름 1).
<!-- counts:end -->
