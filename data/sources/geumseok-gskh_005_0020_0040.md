---
type: "Source"
id: "src-geumseok-gskh_005_0020_0040"
label: "경주 서악동 마애여래삼존입상 협시 관음보살상 배면 각자"
labelHanja: "慶州 西岳洞 磨崖如來三尊立像 挾侍 觀音菩薩像 背面 刻字"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0020_0040"
defaultLens: false
license: "open"
...
# 경주 서악동 마애여래삼존입상 협시 관음보살상 배면 각자

국편 한국고대금석문 벌크의 `gskh_005_0020_0040`. 경로: 통일신라 › 불상명 › 경주 서악동 마애여래삼존입상 협시 관음보살상 배면 각자.
...
출토·소재지 원표기: 경상북도 경주시 서악4길 58 (서악동). 소장처: 없음.
크기: (아미타여래입상) 높이 700㎝; (관음보살상) 높이 455㎝; (대세지보살상) 높이 462㎝. 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_005_0020_0040)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,148.
주석 0(), 색인어 0().
<!-- counts:end -->
