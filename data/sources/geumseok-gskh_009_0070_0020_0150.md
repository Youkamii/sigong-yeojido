---
type: "Source"
id: "src-geumseok-gskh_009_0070_0020_0150"
label: "건무30년명 이배"
labelHanja: "建武三十年銘 耳杯"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
composedYear: 54
coversFrom: 54
...
sourceLevelId: "gskh_009_0070_0020_0150"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0070_0020_0150`. 경로: 낙랑 › 칠기명 › 기년명 칠기 › 건무30년명 이배.
...
XML 날짜: `0054-99-99` — 54년(후한(後漢) 광무제(光武帝) 건무(建武)30년).
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 평양시 락랑구역(樂浪區域) 정백동(貞柏洞) 200호분.
크기: 없음. 서체: 나무.
[국편 항목](https://db.history.go.kr/id/gskh_009_0070_0020_0150)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,011.
