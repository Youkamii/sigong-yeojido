---
type: "Source"
id: "src-geumseok-gskh_010_0060_0030"
label: "「진고구려솔선백장」명 동인"
labelHanja: "「晉高句麗率善佰長」銘 銅印"
sourceKind: "금석문"
...
sourceLevelId: "gskh_010_0060_0030"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_010_0060_0030`. 경로: 중국계 금석문 › 인장명 › 「진고구려솔선백장」명 동인.
...
출토·소재지 원표기: 중국역사박물관(中國歷史博物館) 1점, 소재지 미상 1점. 소장처: 지린성(吉林省) 지안시(集安市) 환도산성(丸都山城) 1점, 미상 1점.
크기: 가로 2.2cm, 세로 2.2cm, 두께 0.7cm. 서체: 전서(篆書).
[국편 항목](https://db.history.go.kr/id/gskh_010_0060_0030)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,181.
주석 10(각주 10), 색인어 0().
<!-- counts:end -->
