---
type: "Source"
id: "src-geumseok-gskh_003_0020_0050"
label: "「영랑」명 석구"
labelHanja: "「永郞」銘 石臼"
sourceKind: "금석문"
sourceGroup: "금석문 · 신라"
...
sourceLevelId: "gskh_003_0020_0050"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_003_0020_0050`. 경로: 신라 › 석각 › 「영랑」명 석구.
...
출토·소재지 원표기: 강원도 강릉시 강동면 하시동 3리[江原道 溟州郡 江東面 下詩洞里]. 소장처: 강원도 강릉시 강동면 하시동 3리.
크기: 길이 81.8cm, 폭 57.6cm, 높이 90.1cm. 서체: 예서(隷書) / 돌.
[국편 항목](https://db.history.go.kr/id/gskh_003_0020_0050)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 5. 연대(dateOccured) 붙은 chunk 2, 본문이 빈 chunk 0, 본문 글자 수 288.
주석 0(), 색인어 2(이름 2).
<!-- counts:end -->
