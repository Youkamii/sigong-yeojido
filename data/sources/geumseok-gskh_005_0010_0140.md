---
type: "Source"
id: "src-geumseok-gskh_005_0010_0140"
label: "남원 실상사 수철화상탑비"
labelHanja: "南原 實相寺 秀澈和尙塔碑"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0010_0140"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0010_0140`. 경로: 통일신라 › 비문 › 남원 실상사 수철화상탑비.
...
XML 날짜: `0905-99-99` — 905년(신라 효공왕 9).
...
출토·소재지 원표기: 전라북도 남원시 산내면 입석길 94-129, 실상사 (입석리). 소장처: 없음.
크기: 166.7㎝ × 112.1㎝. 서체: 해서체.
[국편 항목](https://db.history.go.kr/id/gskh_005_0010_0140)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 11,753.
주석 355(각주 355), 색인어 0().
<!-- counts:end -->
