---
type: "Source"
id: "src-geumseok-gskh_003_0010_0010"
label: "경산 임당동 고비"
labelHanja: "慶山 林堂洞 古碑"
sourceKind: "금석문"
sourceGroup: "금석문 · 신라"
composedYear: null
coversFrom: null
...
sourceLevelId: "gskh_003_0010_0010"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_003_0010_0010`. 경로: 신라 › 비문 › 경산 임당동 고비.
...
XML 날짜: `9999-99-99` — 6세기 중엽~7세기 전반 추정.
...
출토·소재지 원표기: 대구 수성구 청호로 321 (국립대구박물관). 소장처: 경상북도 경산시 조영동 522번지 일원 (경산 임당동 건물지유적).
크기: 높이 66.7㎝, 너비 32.7㎝, 두께 6.5~20.2㎝. 서체: 예서(隷書)풍 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_003_0010_0010)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 2,100.
주석 9(각주 9), 색인어 0().
<!-- counts:end -->
