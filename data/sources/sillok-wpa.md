...
국사편찬위원회 실록원문 벌크 XML(2022-11-03)의 `wpa` 계열 파일을 모은 판본이다.
원문 사료와 수정·보완본을 별도 Source로 둔다. 원문을 합치거나 옳고 그름을 정하지 않는다.

## 연도 근거

[국가기록원 실록 일람표](https://theme.archives.go.kr/next/sillok/sub2_2.do)의 수록 기간 1623~1649, 편찬 연도 1653를 따른다.
...
chunk 가 놓인 층: level2 29 · level3 330 · level5 16,041. 연대(dateOccured) 붙은 chunk 16,068, 본문이 빈 chunk 0, 본문 글자 수 3,088,074.
주석 591(원주 368 · 교감주 223), 색인어 86,836(이름 63,041 · 지명 21,096 · 서명 2,493 · 연호 206).
<!-- counts:end -->

숫자는 `scripts/fill_card_counts.py --source sillok-wpa`와 같은 코드로 센다.
