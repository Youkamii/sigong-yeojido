---
type: "Source"
id: "src-geumseok-gskh_009_0060_0020_1180"
label: "태시10년명 전(1)"
labelHanja: "泰始十年銘 塼(1)"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
composedYear: 274
coversFrom: 274
...
sourceLevelId: "gskh_009_0060_0020_1180"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0060_0020_1180`. 경로: 낙랑 › 와명·전명·토기명 › 전명 › 태시10년명 전(1).
...
XML 날짜: `0274-99-99` — 274년(진(晉) 무제(武帝) 태시(泰始)10년)).
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 황해북도(구 황해도) 봉산군(鳳山郡) 문정면(文井面) 토성리(土城里) 토성지(土城址).
크기: 측면 30×4~5cm, 소구(小口) 14.5×5cm. 서체: 예서체(隷書體) / 흙.
[국편 항목](https://db.history.go.kr/id/gskh_009_0060_0020_1180)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,582.
