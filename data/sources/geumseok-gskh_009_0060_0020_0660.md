---
type: "Source"
id: "src-geumseok-gskh_009_0060_0020_0660"
label: "「장씨」명 전(2)"
labelHanja: "「張氏」銘 塼(2)"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
...
sourceLevelId: "gskh_009_0060_0020_0660"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0060_0020_0660`. 경로: 낙랑 › 와명·전명·토기명 › 전명 › 「장씨」명 전(2).
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 황해남도(구 황해도) 신천군(信川郡) 신천면(信川面) 관촌리(館村里).
크기: 측면 13×4.5cm(약간 결실). 서체: 예서체(隷書體) / 흙.
[국편 항목](https://db.history.go.kr/id/gskh_009_0060_0020_0660)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,564.
주석 0(), 색인어 1(이름 1).
<!-- counts:end -->
