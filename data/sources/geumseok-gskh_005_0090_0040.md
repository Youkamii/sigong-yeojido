---
type: "Source"
id: "src-geumseok-gskh_005_0090_0040"
label: "청주 쌍청리 출토 명문와"
labelHanja: "淸州 雙淸里 出土 銘文瓦"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0090_0040"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0090_0040`. 경로: 통일신라 › 와명·전명 › 청주 쌍청리 출토 명문와.
...
출토·소재지 원표기: 충청북도 청주시 흥덕구 오송읍 쌍청리. 소장처: 없음.
크기: 미상(未詳). 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_005_0090_0040)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,195.
주석 1(각주 1), 색인어 0().
<!-- counts:end -->
