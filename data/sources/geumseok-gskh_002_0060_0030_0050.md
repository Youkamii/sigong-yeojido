---
type: "Source"
id: "src-geumseok-gskh_002_0060_0030_0050"
label: "「정사」명 와"
labelHanja: "「丁巳」銘 瓦"
sourceKind: "금석문"
sourceGroup: "금석문 · 백제"
...
sourceLevelId: "gskh_002_0060_0030_0050"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_002_0060_0030_0050`. 경로: 백제 › 와명·전명 › 부여지역 출토 토기명 › 「정사」명 와.
...
XML 날짜: `0597-99-99` — 597년(위덕왕44년) / 657년(의자왕17년).
...
출토·소재지 원표기: 충청남도 부여군 부여읍 동남리 천왕사지. 소장처: 없음.
크기: 없음. 서체: 흙.
[국편 항목](https://db.history.go.kr/id/gskh_002_0060_0030_0050)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 1. 연대(dateOccured) 붙은 chunk 0, 본문이 빈 chunk 0, 본문 글자 수 69.
주석 0(), 색인어 0().
<!-- counts:end -->
