---
type: "Source"
id: "src-geumseok-gskh_005_0030_0110_0010"
label: "「야유암」명 석각"
labelHanja: "「夜遊岩」銘 石刻"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0030_0110_0010"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0030_0110_0010`. 경로: 통일신라 › 석각 › 전 최치원 석각 › 「야유암」명 석각.
...
출토·소재지 원표기: 경상북도 문경군 가은면 원북리. 소장처: 경상북도 문경군 가은면 원북리.
크기: 자경(字徑) 45.5cm. 서체: 초서 / 돌.
[국편 항목](https://db.history.go.kr/id/gskh_005_0030_0110_0010)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 6. 연대(dateOccured) 붙은 chunk 4, 본문이 빈 chunk 0, 본문 글자 수 250.
주석 0(), 색인어 0().
<!-- counts:end -->
