---
type: "Source"
id: "src-geumseok-gskh_010_0020_0020"
label: "부여 정림사지 오층석탑 미석각자"
labelHanja: "扶餘 定林寺址 五層石塔 楣石刻字"
sourceKind: "금석문"
...
sourceLevelId: "gskh_010_0020_0020"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_010_0020_0020`. 경로: 중국계 금석문 › 석각 › 부여 정림사지 오층석탑 미석각자.
...
출토·소재지 원표기: 충청남도 부여군 정림사지 5층 석탑 1층 옥개받침돌(楣石). 소장처: 충청남도 부여군 정림사지 5층 석탑 1층 옥개받침돌(楣石).
크기: 없음. 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_010_0020_0020)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,027.
주석 2(각주 1 · DB주석 1), 색인어 0().
<!-- counts:end -->
