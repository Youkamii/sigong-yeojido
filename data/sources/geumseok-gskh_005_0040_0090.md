---
type: "Source"
id: "src-geumseok-gskh_005_0040_0090"
label: "담양 개선사지 석등기"
labelHanja: "潭陽 開仙寺址 石燈記"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0040_0090"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0040_0090`. 경로: 통일신라 › 탑명·등명 › 담양 개선사지 석등기.
...
XML 날짜: `0868-99-99` — 868년(신라 경문왕 8년), 891년(신라 진성여왕 5년).
...
출토·소재지 원표기: 전라남도 담양군 가사문학면 학선리 593-2. 소장처: 없음.
크기: 높이 3.5m. 서체: 해서.
[국편 항목](https://db.history.go.kr/id/gskh_005_0040_0090)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 3,342.
주석 42(각주 35 · 소자쌍행 7), 색인어 0().
<!-- counts:end -->
