---
type: "Source"
id: "src-geumseok-gskh_003_0060_0020"
label: "신라와경편"
labelHanja: "新羅瓦經片"
sourceKind: "금석문"
sourceGroup: "금석문 · 신라"
...
sourceLevelId: "gskh_003_0060_0020"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_003_0060_0020`. 경로: 신라 › 와명·전명 › 신라와경편.
...
출토·소재지 원표기: 없음. 소장처: 없음.
크기: (經 1) : 세로 7cm, 가로 9.5cm, 字徑 1.0cm (經 2) : 세로 7.3cm, 가로 10cm, 두께 2.1cm, 字徑 1.0cm. 서체: 없음.
[국편 항목](https://db.history.go.kr/id/gskh_003_0060_0020)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 5. 연대(dateOccured) 붙은 chunk 3, 본문이 빈 chunk 0, 본문 글자 수 655.
주석 0(), 색인어 0().
<!-- counts:end -->
