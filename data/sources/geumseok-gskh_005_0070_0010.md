---
type: "Source"
id: "src-geumseok-gskh_005_0070_0010"
label: "상원사 동종명"
labelHanja: "上院寺 銅鍾銘"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0070_0010"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0070_0010`. 경로: 통일신라 › 종명·금구명 › 상원사 동종명.
...
XML 날짜: `0725-99-99` — 725년(신라 성덕왕 24).
...
출토·소재지 원표기: 강원도 평창군 진부면 오대산로 1211-14 상원사. 소장처: 없음.
크기: 종의 높이 167㎝, 입지름 91㎝, 글자크기 2.1㎝. 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_005_0070_0010)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 2,520.
주석 21(각주 21), 색인어 0().
<!-- counts:end -->
