---
type: "Source"
id: "src-geumseok-gskh_009_0060_0020_1110"
label: "태강7년명 전(1)"
labelHanja: "太康七年銘 塼(1)"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
composedYear: 286
coversFrom: 286
...
sourceLevelId: "gskh_009_0060_0020_1110"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0060_0020_1110`. 경로: 낙랑 › 와명·전명·토기명 › 전명 › 태강7년명 전(1).
...
XML 날짜: `0286-99-99` — 286년(진(晉) 무제(武帝) 태강(太康)7년).
...
크기: 측면 35×3.4cm. 서체: 예서체(隷書體) / 흙.
[국편 항목](https://db.history.go.kr/id/gskh_009_0060_0020_1110)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,549.
주석 1(각주 1), 색인어 0().
<!-- counts:end -->
