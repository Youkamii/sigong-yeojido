---
type: "Source"
id: "src-geumseok-gskh_008_0010_0020"
label: "부여씨부인 묘지명"
labelHanja: "扶餘氏夫人 墓誌銘"
sourceKind: "금석문"
...
sourceLevelId: "gskh_008_0010_0020"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_008_0010_0020`. 경로: 백제 유민 관련 금석문 › 묘지명 › 부여씨부인 묘지명.
...
XML 날짜: `0738-99-99` — 738년(唐 開元 26년).
...
출토·소재지 원표기: 中國 陝西省考古硏究院. 소장처: 中國 陝西省 富平縣 呂村鄕.
크기: (개석) 가로 74cm, 세로 70cm, 두께 13cm; (지석) 가로 74cm, 세로 70cm, 두께 9cm. 서체: (개석) 전서체; (지석) 해서체.
[국편 항목](https://db.history.go.kr/id/gskh_008_0010_0020)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 7,636.
주석 63(각주 63), 색인어 0().
<!-- counts:end -->
