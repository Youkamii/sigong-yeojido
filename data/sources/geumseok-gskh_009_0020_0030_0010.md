---
type: "Source"
id: "src-geumseok-gskh_009_0020_0030_0010"
label: "부씨작명 반룡경"
labelHanja: "孚氏作銘 盤龍鏡"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
...
sourceLevelId: "gskh_009_0020_0030_0010"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0020_0030_0010`. 경로: 낙랑 › 동경명 › 반룡경 › 부씨작명 반룡경.
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 전(傳) 평양시 락랑구역(樂浪區域) 토성동(土城洞)(구 대동강면(大同江面) 토성리).
크기: 없음. 서체: 예서체(隷書體) / 동.
[국편 항목](https://db.history.go.kr/id/gskh_009_0020_0030_0010)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 8. 연대(dateOccured) 붙은 chunk 5, 본문이 빈 chunk 0, 본문 글자 수 705.
주석 0(), 색인어 1(이름 1).
<!-- counts:end -->
