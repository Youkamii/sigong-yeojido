---
type: "Source"
id: "src-geumseok-gskh_008_0010_0040"
label: "예군 묘지명"
labelHanja: "禰軍 墓誌銘"
sourceKind: "금석문"
...
sourceLevelId: "gskh_008_0010_0040"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_008_0010_0040`. 경로: 백제 유민 관련 금석문 › 묘지명 › 예군 묘지명.
...
XML 날짜: `0678-99-99` — 678년(唐 儀鳳 3년).
...
출토·소재지 원표기: 中國 西安博物院. 소장처: 中國 西安.
크기: (개석) 미상; (지석) 가로 59cm, 세로 59cm, 두께 10cm. 서체: (개석) 전서체; (지석) 해서체.
[국편 항목](https://db.history.go.kr/id/gskh_008_0010_0040)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 9,282.
주석 120(각주 112 · 소자쌍행 8), 색인어 0().
<!-- counts:end -->
