---
type: "Source"
id: "src-geumseok-gskh_007_0010_0030"
label: "고목로 묘지명"
labelHanja: "高木盧 墓誌銘"
sourceKind: "금석문"
...
sourceLevelId: "gskh_007_0010_0030"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_007_0010_0030`. 경로: 고구려 유민 관련 금석문 › 묘지명 › 고목로 묘지명.
...
XML 날짜: `0730-99-99` — 730년(당 開元 18년).
...
출토·소재지 원표기: 中國 西安 碑林博物館. 소장처: 陕西省 西安市 郭家灘.
크기: (지석) 가로 45cm, 세로 44cm. 서체: (지석) 전서체.
[국편 항목](https://db.history.go.kr/id/gskh_007_0010_0030)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 4,192.
주석 37(각주 35 · 소자쌍행 2), 색인어 0().
<!-- counts:end -->
