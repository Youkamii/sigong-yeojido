---
type: "Source"
id: "src-geumseok-gskh_003_0010_0080"
label: "마운령 신라 진흥왕 순수비"
labelHanja: "磨雲嶺 新羅 眞興王 巡狩碑"
sourceKind: "금석문"
sourceGroup: "금석문 · 신라"
composedYear: 568
coversFrom: 568
...
sourceLevelId: "gskh_003_0010_0080"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_003_0010_0080`. 경로: 신라 › 비문 › 마운령 신라 진흥왕 순수비.
...
출토·소재지 원표기: 함경남도 함흥시 사포구역 소나무동(함흥본궁). 소장처: 함경남도 이원군 동면 사동 만덕산 복흥사의 배후에 솟아 있는 운시산 정상.
크기: 높이 146.9㎝, 너비 44.2㎝, 두께 30.0㎝. 서체: 해서체.
[국편 항목](https://db.history.go.kr/id/gskh_003_0010_0080)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 4,909.
주석 66(각주 66), 색인어 0().
<!-- counts:end -->
