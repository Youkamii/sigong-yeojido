---
type: "Source"
id: "src-geumseok-gskh_002_0040_0020"
label: "갑오명 금동일광삼존불상"
labelHanja: "甲午銘 金銅一光三尊佛像"
sourceKind: "금석문"
sourceGroup: "금석문 · 백제"
composedYear: 574
coversFrom: 574
...
sourceLevelId: "gskh_002_0040_0020"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_002_0040_0020`. 경로: 백제 › 불상명 › 갑오명 금동일광삼존불상.
...
XML 날짜: `0574-99-99` — 574년(백제 위덕왕 21) 추정.
...
출토·소재지 원표기: 충청남도 서산군. 소장처: 없음.
크기: 전체높이 17㎝ (본존불) 높이 9.3 ㎝, 어깨너비 1.8㎝; (협시보살) 높이 5.2㎝; (대좌) 높이 3.2㎝, 지름 5.3~5.4㎝; (광배) 높이 13㎝, 중앙너비 7㎝. 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_002_0040_0020)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,087.
주석 2(각주 2), 색인어 0().
<!-- counts:end -->
