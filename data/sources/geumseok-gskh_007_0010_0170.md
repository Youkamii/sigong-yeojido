---
type: "Source"
id: "src-geumseok-gskh_007_0010_0170"
label: "왕경요 묘지명"
labelHanja: "王景曜 墓誌銘"
sourceKind: "금석문"
...
sourceLevelId: "gskh_007_0010_0170"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_007_0010_0170`. 경로: 고구려 유민 관련 금석문 › 묘지명 › 왕경요 묘지명.
...
XML 날짜: `0735-99-99` — 735년(唐 開元 23년).
...
출토·소재지 원표기: 中國 洛陽 新安縣 千唐志齋. 소장처: 없음.
크기: (지석) 가로 59cm, 세로 59cm. 서체: 미상(未詳).
[국편 항목](https://db.history.go.kr/id/gskh_007_0010_0170)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 6,655.
주석 66(각주 64 · 소자쌍행 2), 색인어 0().
<!-- counts:end -->
