...
국편 한국고대사료집성 중국편에 실린 『續古今譯經圖紀』의 한국사 관련 발췌다.
사서 전체 원문을 수록한 것으로 표시하지 않는다. 국편 사서 id `ko_069`를 Source 이름에 쓴다.
...
chunk 가 놓인 층: level3 6. 연대(dateOccured) 붙은 chunk 0, 본문이 빈 chunk 0, 본문 글자 수 1,508.
주석 39(원주 39), 색인어 184(이름 100 · 서명 41 · 지명 25 · 국명 12 · 연호 6).
<!-- counts:end -->
