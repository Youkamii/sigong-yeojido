---
type: "Source"
id: "src-geumseok-gskh_005_0110_0030"
label: "이천 설봉산성 출토 「함통6년」명 벼루"
labelHanja: "利川 雪峰山城 出土 「咸通六年」銘 硯"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0110_0030"
defaultLens: false
license: "open"
...
# 이천 설봉산성 출토 「함통6년」명 벼루

국편 한국고대금석문 벌크의 `gskh_005_0110_0030`. 경로: 통일신라 › 기타 › 이천 설봉산성 출토 「함통6년」명 벼루.
...
XML 날짜: `0865-99-99` — 865년(신라 경문왕 5), 866년(신라 경문왕 6).
...
출토·소재지 원표기: 경기도 이천시 사음동 산24번지 (이천 설봉산성). 소장처: 없음.
크기: 길이 9.8㎝, 너비 5.7~7.5㎝, 두께 0.3~1.4㎝. 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_005_0110_0030)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,245.
주석 7(각주 7), 색인어 0().
<!-- counts:end -->
