---
type: "Source"
id: "src-geumseok-gskh_005_0010_0010"
label: "경주 무장사지 아미타불 조상 사적비"
labelHanja: "慶州 䥐藏寺址 阿彌陀佛 造像 事蹟碑"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0010_0010"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0010_0010`. 경로: 통일신라 › 비문 › 경주 무장사지 아미타불 조상 사적비.
...
XML 날짜: `0801-99-99` — 哀莊王 二年(八○一)으로 추정.
...
출토·소재지 원표기: 國立中央博物館(原 慶北 慶州市 內東面 暗谷里 䥐藏寺址). 소장처: 없음.
크기: 세로 29cm、가로 48cm、글자크기 1.8cm. 서체: 行書.
[국편 항목](https://db.history.go.kr/id/gskh_005_0010_0010)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 8. 연대(dateOccured) 붙은 chunk 6, 본문이 빈 chunk 0, 본문 글자 수 5,662.
주석 38(각주 38), 색인어 22(관직 10 · 이름 6 · 지명 6).
<!-- counts:end -->
