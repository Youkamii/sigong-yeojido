---
type: "Source"
id: "src-geumseok-gskh_007_0010_0220"
label: "천비 묘지명"
labelHanja: "泉毖 墓誌銘"
sourceKind: "금석문"
...
sourceLevelId: "gskh_007_0010_0220"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_007_0010_0220`. 경로: 고구려 유민 관련 금석문 › 묘지명 › 천비 묘지명.
...
XML 날짜: `0733-99-99` — 733년(唐 開元 21년).
...
출토·소재지 원표기: 낙양박물관(洛陽博物館). 소장처: 하남성(河南省) 낙양시(洛陽市) 맹진현(孟津縣) 동산두촌(東山頭村) 일대.
크기: 가로·세로 각각 60㎝×60㎝. 서체: 楷書.
[국편 항목](https://db.history.go.kr/id/gskh_007_0010_0220)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 4,862.
주석 57(각주 57), 색인어 0().
<!-- counts:end -->
