---
type: "Source"
id: "src-geumseok-gskh_001_0050_0010"
label: "경주 호우총 출토 청동 ‘광개토대왕’명 호우"
labelHanja: "慶州 壺杅塚 出土 靑銅 ‘廣開土大王’銘 壺杅"
sourceKind: "금석문"
sourceGroup: "금석문 · 고구려"
composedYear: 415
coversFrom: 415
...
sourceLevelId: "gskh_001_0050_0010"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_001_0050_0010`. 경로: 고구려 › 금속기명 › 경주 호우총 출토 청동 ‘광개토대왕’명 호우.
...
XML 날짜: `0415-99-99` — 長壽王 三年(四一五) 推定.
...
출토·소재지 원표기: 國立中央博物館. 소장처: 없음.
크기: 없음. 서체: 楷書.
[국편 항목](https://db.history.go.kr/id/gskh_001_0050_0010)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 9. 연대(dateOccured) 붙은 chunk 7, 본문이 빈 chunk 0, 본문 글자 수 1,242.
주석 1(각주 1), 색인어 7(이름 7).
<!-- counts:end -->
