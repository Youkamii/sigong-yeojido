---
type: "Source"
id: "src-geumseok-gskh_007_0010_0110"
label: "고진 묘지명"
labelHanja: "高震 墓誌銘"
sourceKind: "금석문"
...
sourceLevelId: "gskh_007_0010_0110"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_007_0010_0110`. 경로: 고구려 유민 관련 금석문 › 묘지명 › 고진 묘지명.
...
XML 날짜: `0778-99-99` — 733년(唐 開元 21년).
...
출토·소재지 원표기: 미상. 소장처: 하남성(河南省) 낙양시(洛陽市) 망산(邙山).
크기: 가로·세로 각각 50㎝×50㎝. 서체: 楷書.
[국편 항목](https://db.history.go.kr/id/gskh_007_0010_0110)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 4,538.
주석 47(각주 47), 색인어 0().
<!-- counts:end -->
