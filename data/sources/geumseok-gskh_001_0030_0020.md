---
type: "Source"
id: "src-geumseok-gskh_001_0030_0020"
label: "평양성 석각(1)"
labelHanja: "平壤城 石刻"
sourceKind: "금석문"
sourceGroup: "금석문 · 고구려"
...
sourceLevelId: "gskh_001_0030_0020"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_001_0030_0020`. 경로: 고구려 › 석각 › 평양성 석각(1).
...
크기: 미상(未詳). 서체: 미상(未詳).
[국편 항목](https://db.history.go.kr/id/gskh_001_0030_0020)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 5. 연대(dateOccured) 붙은 chunk 2, 본문이 빈 chunk 0, 본문 글자 수 2,529.
주석 3(각주 3), 색인어 4(관직 2 · 이름 2).
<!-- counts:end -->
