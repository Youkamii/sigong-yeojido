---
type: "Source"
id: "src-geumseok-gskh_005_0020_0050"
label: "기축명 아미타불비상 명문"
labelHanja: "己丑銘 阿彌陀佛碑像 銘文"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0020_0050"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0020_0050`. 경로: 통일신라 › 불상명 › 기축명 아미타불비상 명문.
...
XML 날짜: `0689-99-99` — 신라 신문왕 9년(689) 추정.
...
출토·소재지 원표기: 충북 청주시 상당구 명암로 143 국립청주박물관. 소장처: 세종특별자치시 전의면 비암사길 137 비암사.
크기: 높이 57.5㎝, 아래 너비 31.5㎝, 측면 8.5㎝, 글자크기 2㎝. 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_005_0020_0050)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 2,164.
주석 7(각주 7), 색인어 0().
<!-- counts:end -->
