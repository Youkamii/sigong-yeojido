---
type: "Source"
id: "src-geumseok-gskh_009_0070_0030_0060"
label: "석암리 20호분 출토 칠기 명문"
labelHanja: "石巖里 20號墳 出土 漆器 銘文"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
composedYear: null
coversFrom: null
...
sourceLevelId: "gskh_009_0070_0030_0060"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0070_0030_0060`. 경로: 낙랑 › 칠기명 › 명문 칠기 › 석암리 20호분 출토 칠기 명문.
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 평안남도 평원군 평원면(구 대동군(大同郡) 대동강면(大同江面)) 석암리(石巖里) 20호분.
크기: ① 무음가명(舞陰家銘) 칠반: 예서체(隷書體). 서체: 나무.
[국편 항목](https://db.history.go.kr/id/gskh_009_0070_0030_0060)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,069.
주석 3(각주 3), 색인어 2(지명 1 · 이름 1).
<!-- counts:end -->
