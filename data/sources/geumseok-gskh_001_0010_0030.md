---
type: "Source"
id: "src-geumseok-gskh_001_0010_0030"
label: "충주 고구려비"
labelHanja: "忠州 高句麗碑"
sourceKind: "금석문"
sourceGroup: "금석문 · 고구려"
...
sourceLevelId: "gskh_001_0010_0030"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_001_0010_0030`. 경로: 고구려 › 비문 › 충주 고구려비.
...
XML 날짜: `9999-99-99` — 長壽王 혹은 文咨王代 推定.
...
출토·소재지 원표기: 忠淸北道 中原郡 可金面 龍田里. 소장처: 없음.
크기: 높이 135cm、전면폭 55cm、좌측면폭 37cm. 서체: 楷書.
[국편 항목](https://db.history.go.kr/id/gskh_001_0010_0030)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 12. 연대(dateOccured) 붙은 chunk 9, 본문이 빈 chunk 0, 본문 글자 수 15,476.
주석 155(각주 155), 색인어 187(이름 90 · 관직 80 · 지명 17).
<!-- counts:end -->
