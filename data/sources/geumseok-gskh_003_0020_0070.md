---
type: "Source"
id: "src-geumseok-gskh_003_0020_0070"
label: "울진 성류굴 신라 석각 명문"
labelHanja: "蔚珍 聖留窟 新羅 石刻 銘文"
sourceKind: "금석문"
sourceGroup: "금석문 · 신라"
composedYear: 543
coversFrom: 543
...
sourceLevelId: "gskh_003_0020_0070"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_003_0020_0070`. 경로: 신라 › 석각 › 울진 성류굴 신라 석각 명문.
...
XML 날짜: `0543-99-99` — 543년(신라 진흥왕 4) 혹은 603년(신라 진평왕 25) 혹은 663년(신라 문무왕 3).
...
출토·소재지 원표기: 경상북도 울진군 근남면 구산리 산30 (울진 성류굴). 소장처: 없음.
크기: (석각면) 가로 (30)㎝, 세로 (20)㎝. 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_003_0020_0070)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,577.
주석 15(각주 15), 색인어 0().
<!-- counts:end -->
