---
type: "Source"
id: "src-geumseok-gskh_009_0060_0020_0790"
label: "「함자왕군」명 전 (2종)"
labelHanja: "「含資王君」銘 塼 (2종)"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
composedYear: null
coversFrom: null
...
sourceLevelId: "gskh_009_0060_0020_0790"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0060_0020_0790`. 경로: 낙랑 › 와명·전명·토기명 › 전명 › 「함자왕군」명 전 (2종).
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 황해남도(구 황해도) 안악군(安岳郡) 안악읍 유성리(柳城里).
크기: 측면 31×5cm. 서체: 흙.
[국편 항목](https://db.history.go.kr/id/gskh_009_0060_0020_0790)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,547.
주석 4(각주 4), 색인어 4(지명 2 · 이름 2).
<!-- counts:end -->
