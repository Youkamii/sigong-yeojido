---
type: "Source"
id: "src-geumseok-gskh_009_0060_0020_0930"
label: "영가명 전"
labelHanja: "永嘉銘 塼"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
...
sourceLevelId: "gskh_009_0060_0020_0930"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0060_0020_0930`. 경로: 낙랑 › 와명·전명·토기명 › 전명 › 영가명 전.
...
XML 날짜: `03##-99-99` — 307~312년(진(晉) 회제(懷帝) 영가(永嘉)연간) 추정.
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 황해남도(구 황해도) 신천군(信川郡) 남부면(南部面) 서원리(書院里).
크기: 예서체(隷書體) / 흙. 서체: 와명·전명.
[국편 항목](https://db.history.go.kr/id/gskh_009_0060_0020_0930)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,657.
