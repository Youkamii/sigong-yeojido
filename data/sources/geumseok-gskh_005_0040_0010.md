---
type: "Source"
id: "src-geumseok-gskh_005_0040_0010"
label: "영태2년명 탑지"
labelHanja: "永泰二年銘 塔誌"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0040_0010"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0040_0010`. 경로: 통일신라 › 탑명·등명 › 영태2년명 탑지.
...
XML 날짜: `0766-99-99` — 766년(신라 혜공왕 2년), 993년(고려 성종 12년).
...
출토·소재지 원표기: 서울특별시 중구 필동로1길 30 동국대학교 박물관. 소장처: 경기도 안성시 죽산면 미륵당길 32-2.
크기: 가로 11.3㎝, 세로 10.5㎝, 높이 4.2㎝; 옆면 글자크기 1.2~1.5㎝, 밑면 글자크기 1.2㎝. 서체: 옆면/행서(行書), 밑면/해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_005_0040_0010)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,867.
주석 16(각주 16), 색인어 0().
<!-- counts:end -->
