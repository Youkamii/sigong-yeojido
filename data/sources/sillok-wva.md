...
국사편찬위원회 실록원문 벌크 XML(2022-11-03)의 `wva` 계열 파일을 모은 판본이다.
원문 사료와 수정·보완본을 별도 Source로 둔다. 원문을 합치거나 옳고 그름을 정하지 않는다.

## 연도 근거

[국가기록원 실록 일람표](https://theme.archives.go.kr/next/sillok/sub2_2.do)의 수록 기간 1776~1800, 편찬 연도 1805를 따른다.
...
chunk 가 놓인 층: level2 28 · level3 312 · level5 17,671. 연대(dateOccured) 붙은 chunk 17,696, 본문이 빈 chunk 0, 본문 글자 수 4,424,310.
주석 1,925(원주 1,298 · 교감주 627), 색인어 103,326(이름 71,006 · 지명 27,898 · 서명 4,107 · 연호 315).
<!-- counts:end -->

숫자는 `scripts/fill_card_counts.py --source sillok-wva`와 같은 코드로 센다.
