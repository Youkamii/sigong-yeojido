...
국사편찬위원회 실록원문 벌크 XML(2022-11-03)의 `wla` 계열 파일을 모은 판본이다.
원문 사료와 수정·보완본을 별도 Source로 둔다. 원문을 합치거나 옳고 그름을 정하지 않는다.

## 연도 근거

[국가기록원 실록 일람표](https://theme.archives.go.kr/next/sillok/sub2_2.do)의 수록 기간 1545~1545, 편찬 연도 1550를 따른다.
...
chunk 가 놓인 층: level2 3 · level3 12 · level5 667. 연대(dateOccured) 붙은 chunk 668, 본문이 빈 chunk 0, 본문 글자 수 161,054.
주석 279(원주 174 · 교감주 105), 색인어 3,052(이름 2,487 · 지명 476 · 서명 72 · 연호 17).
<!-- counts:end -->

숫자는 `scripts/fill_card_counts.py --source sillok-wla`와 같은 코드로 센다.
