---
type: "Source"
id: "src-geumseok-gskh_005_0020_0140"
label: "함안 방어산 마애약사여래삼존입상 조상기"
labelHanja: "咸安 防禦山 磨崖藥師如來三尊立像 造像記"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0020_0140"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0020_0140`. 경로: 통일신라 › 불상명 › 함안 방어산 마애약사여래삼존입상 조상기.
...
XML 날짜: `0801-99-99` — 801년(신라 애장왕 2년).
...
출토·소재지 원표기: 경남 함안군 군북면 하림리 산 131 방어산 정상. 소장처: 없음.
크기: 글자 5~7㎝. 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_005_0020_0140)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,660.
주석 23(각주 23), 색인어 0().
<!-- counts:end -->
