---
type: "Source"
id: "src-geumseok-gskh_008_0010_0060"
label: "예식진 묘지명"
labelHanja: "禰寔進 墓誌銘"
sourceKind: "금석문"
...
sourceLevelId: "gskh_008_0010_0060"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_008_0010_0060`. 경로: 백제 유민 관련 금석문 › 묘지명 › 예식진 묘지명.
...
XML 날짜: `0672-99-99` — 672년(唐 咸亨 3년).
...
출토·소재지 원표기: 中國 洛陽理工學院 도서관. 소장처: 中國 西安.
크기: (개석) 가로 57㎝, 세로 57㎝, 두께 15㎝; (지석) 가로 58.5㎝, 세로 58.5㎝, 두께 13㎝. 서체: (개석) 전서체; (지석) 해서체.
[국편 항목](https://db.history.go.kr/id/gskh_008_0010_0060)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 4,528.
주석 58(각주 56 · 소자쌍행 2), 색인어 0().
<!-- counts:end -->
