---
type: "Source"
id: "src-geumseok-gskh_009_0060_0020_0360"
label: "「왕」명 전(2)"
labelHanja: "「王」銘 塼(2)"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
...
sourceLevelId: "gskh_009_0060_0020_0360"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0060_0020_0360`. 경로: 낙랑 › 와명·전명·토기명 › 전명 › 「왕」명 전(2).
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 평양시 락랑구역(樂浪區域) 정백동(貞柏洞)(구: 평안남도 대동군(大同郡) 대동강면(大同江面) 1호분).
크기: 없음. 서체: 흙.
[국편 항목](https://db.history.go.kr/id/gskh_009_0060_0020_0360)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,513.
주석 0(), 색인어 1(이름 1).
<!-- counts:end -->
