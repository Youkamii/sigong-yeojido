...
국사편찬위원회 실록원문 벌크 XML(2022-11-03)의 `wga` 계열 파일을 모은 판본이다.
원문 사료와 수정·보완본을 별도 Source로 둔다. 원문을 합치거나 옳고 그름을 정하지 않는다.

## 연도 근거

[국가기록원 실록 일람표](https://theme.archives.go.kr/next/sillok/sub2_2.do)의 수록 기간 1455~1468, 편찬 연도 1471를 따른다.
...
chunk 가 놓인 층: level2 17 · level3 201 · level4 8 · level5 10,864. 연대(dateOccured) 붙은 chunk 10,820, 본문이 빈 chunk 0, 본문 글자 수 1,656,515.
주석 1,981(교감주 1,015 · 원주 966), 색인어 84,031(이름 56,697 · 지명 25,486 · 서명 1,585 · 연호 263).
<!-- counts:end -->

숫자는 `scripts/fill_card_counts.py --source sillok-wga`와 같은 코드로 센다.
