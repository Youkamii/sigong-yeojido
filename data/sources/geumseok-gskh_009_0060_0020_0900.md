---
type: "Source"
id: "src-geumseok-gskh_009_0060_0020_0900"
label: "경원3년명 전"
labelHanja: "景元三年銘 塼"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
...
sourceLevelId: "gskh_009_0060_0020_0900"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0060_0020_0900`. 경로: 낙랑 › 와명·전명·토기명 › 전명 › 경원3년명 전.
...
XML 날짜: `0262-99-99` — 262년(위(魏) 원제(元帝) 경원(景元)3년).
...
출토·소재지 원표기: 일본. 소장처: 황해북도(구 황해도) 봉산군(鳳山郡) 문정면(文井面) 토성리(土城里) 토성지(土城址).
크기: 없음. 서체: 흙.
[국편 항목](https://db.history.go.kr/id/gskh_009_0060_0020_0900)의 id를 연결 정보로 보존했다.
