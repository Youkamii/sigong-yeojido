---
type: "Source"
id: "src-geumseok-gskh_005_0070_0040"
label: "양양 선림원지 종명"
labelHanja: "襄陽 禪林院址 鍾銘"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0070_0040"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0070_0040`. 경로: 통일신라 › 종명·금구명 › 양양 선림원지 종명.
...
XML 날짜: `0804-99-99` — 804년(신라 애장왕 5).
...
출토·소재지 원표기: 강원도 춘천시 우석로 70 국립춘천박물관. 소장처: 강원도 양양군 서면 서림리 424 선림원지.
크기: 전체 높이 122㎝, 종신 96㎝, 입지름 68㎝. 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_005_0070_0040)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 2,732.
주석 36(각주 36), 색인어 0().
<!-- counts:end -->
