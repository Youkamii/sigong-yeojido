---
type: "Source"
id: "src-geumseok-gskh_005_0010_0040"
label: "경주 성덕왕릉 비편"
labelHanja: "慶州 聖德王陵 碑片"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0010_0040"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0010_0040`. 경로: 통일신라 › 비문 › 경주 성덕왕릉 비편.
...
출토·소재지 원표기: 경상북도 경주시 일정로 186(인왕동, 국립경주박물관). 소장처: 경상북도 경주시 조양동 666 성덕왕릉비 귀부.
크기: 크기 3.0㎝(글자 크기). 서체: 해서체.
[국편 항목](https://db.history.go.kr/id/gskh_005_0010_0040)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,097.
주석 0(), 색인어 0().
<!-- counts:end -->
