---
type: "Source"
id: "src-geumseok-gskh_009_0060_0020_0860"
label: "건시원년명 전"
labelHanja: "建始元年銘 塼"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
...
sourceLevelId: "gskh_009_0060_0020_0860"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0060_0020_0860`. 경로: 낙랑 › 와명·전명·토기명 › 전명 › 건시원년명 전.
...
XML 날짜: `0407-99-99` — 407년(후연(後燕) 모용수(慕容垂) 건시(建始)원년).
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 황해남도(구 황해도) 신천군(信川郡) 용문면(龍門面) 복우리(福隅里).
크기: 없음. 서체: 예서(隷書) / 흙.
[국편 항목](https://db.history.go.kr/id/gskh_009_0060_0020_0860)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,593.
