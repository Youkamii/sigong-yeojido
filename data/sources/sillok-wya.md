...
국사편찬위원회 실록원문 벌크 XML(2022-11-03)의 `wya` 계열 파일을 모은 판본이다.
원문 사료와 수정·보완본을 별도 Source로 둔다. 원문을 합치거나 옳고 그름을 정하지 않는다.

## 연도 근거

[국가기록원 실록 일람표](https://theme.archives.go.kr/next/sillok/sub2_2.do)의 수록 기간 1849~1863, 편찬 연도 1865를 따른다.
...
chunk 가 놓인 층: level2 17 · level3 187 · level5 5,764. 연대(dateOccured) 붙은 chunk 5,779, 본문이 빈 chunk 0, 본문 글자 수 281,918.
주석 256(원주 158 · 교감주 98), 색인어 11,760(이름 8,286 · 지명 3,323 · 서명 130 · 연호 21).
<!-- counts:end -->

숫자는 `scripts/fill_card_counts.py --source sillok-wya`와 같은 코드로 센다.
