---
type: "Source"
id: "src-geumseok-gskh_003_0010_0140"
label: "포항 냉수리 신라비"
labelHanja: "浦項 冷水里 新羅碑"
sourceKind: "금석문"
sourceGroup: "금석문 · 신라"
composedYear: 503
coversFrom: 503
...
sourceLevelId: "gskh_003_0010_0140"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_003_0010_0140`. 경로: 신라 › 비문 › 포항 냉수리 신라비.
...
XML 날짜: `0503-99-99` — 503년(지증마립간 4).
...
출토·소재지 원표기: 경상북도 포항시 북구 신광면 사무소. 소장처: 경상북도 포항시 북구 신광면 냉수2리 밭(재발견지).
크기: 높이 60㎝, 폭 70㎝, 두께 30㎝. 서체: 해서체(楷書)이나 예서체(隷書)도 가미.
[국편 항목](https://db.history.go.kr/id/gskh_003_0010_0140)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 5,003.
주석 91(각주 91), 색인어 0().
<!-- counts:end -->
