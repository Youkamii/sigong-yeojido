---
type: "Source"
id: "src-geumseok-gskh_009_0070_0030_0230"
label: "정백리 127호분(왕광묘) 출토 칠기 명문"
labelHanja: "貞柏里 127號墳(王光墓) 出土 漆器 銘文"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
composedYear: null
coversFrom: null
...
sourceLevelId: "gskh_009_0070_0030_0230"
defaultLens: false
license: "open"
...
# 정백리 127호분(왕광묘) 출토 칠기 명문

국편 한국고대금석문 벌크의 `gskh_009_0070_0030_0230`. 경로: 낙랑 › 칠기명 › 명문 칠기 › 정백리 127호분(왕광묘) 출토 칠기 명문.
...
출토·소재지 원표기: 북한. 소장처: 평양시 락랑구역(樂浪區域) 정백동(貞柏洞, 구: 정백리) 127호분(왕광묘(王光墓)).
크기: 미상(未詳). 서체: ⑥ 왕대리명(王大利銘)이배: 한전체(漢篆體), ⑦ 익광명(益光銘)이배: 한예체(漢隷體), ⑩ 장수연년의자손명(長壽延年宜子孫銘)대갑(大匣): 예서체(隷書體) / 나무.
[국편 항목](https://db.history.go.kr/id/gskh_009_0070_0030_0230)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,809.
주석 8(각주 8), 색인어 11(이름 11).
<!-- counts:end -->
