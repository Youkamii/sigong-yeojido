---
type: "Source"
id: "src-geumseok-gskh_009_0060_0020_0040"
label: "「□월이일」명 전"
labelHanja: "「□月二日」銘 塼"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
...
sourceLevelId: "gskh_009_0060_0020_0040"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0060_0020_0040`. 경로: 낙랑 › 와명·전명·토기명 › 전명 › 「□월이일」명 전.
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 황해남도(구 황해도) 신천군(信川郡) 가산면(加山面) 병동(丙洞).
크기: 측면 13×4.5cm(약간 결실). 서체: 예서(隷書) / 흙.
[국편 항목](https://db.history.go.kr/id/gskh_009_0060_0020_0040)의 id를 연결 정보로 보존했다.
