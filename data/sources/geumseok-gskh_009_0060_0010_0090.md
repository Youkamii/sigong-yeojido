---
type: "Source"
id: "src-geumseok-gskh_009_0060_0010_0090"
label: "「안평락미앙」명 와당"
labelHanja: "「安平樂未央」銘 瓦當"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
composedYear: null
coversFrom: null
...
sourceLevelId: "gskh_009_0060_0010_0090"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0060_0010_0090`. 경로: 낙랑 › 와명·전명·토기명 › 와명 › 「안평락미앙」명 와당.
...
출토·소재지 원표기: 중국 요령성(遼寧省) 박물관. 소장처: 요령성(遼寧省) 단동시(丹東市) 애하(靉河) 하구 삼각주상의 고성지(古城址).
크기: 면경(面徑) 12.5cm. 서체: 예서체(隷書體) / 흙.
[국편 항목](https://db.history.go.kr/id/gskh_009_0060_0010_0090)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,568.
주석 2(각주 2), 색인어 1(지명 1).
<!-- counts:end -->
