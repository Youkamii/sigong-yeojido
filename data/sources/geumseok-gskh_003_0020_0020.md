---
type: "Source"
id: "src-geumseok-gskh_003_0020_0020"
label: "「대태각」명 석편"
labelHanja: "「大太角」銘 石片"
sourceKind: "금석문"
sourceGroup: "금석문 · 신라"
...
sourceLevelId: "gskh_003_0020_0020"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_003_0020_0020`. 경로: 신라 › 석각 › 「대태각」명 석편.
...
출토·소재지 원표기: 경상북도 경주시 교동 천관사지(天官寺址) 동편[慶州市 校洞 天官寺址 동편 出土(黃壽永所藏)]. 소장처: 황수영 소장.
크기: 높이 16cm, 너비 12cm, 두께 3~8cm. 서체: 전서(篆書) / 돌.
[국편 항목](https://db.history.go.kr/id/gskh_003_0020_0020)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 2, 본문이 빈 chunk 0, 본문 글자 수 396.
주석 0(), 색인어 2(관직 2).
<!-- counts:end -->
