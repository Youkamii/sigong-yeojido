...
국사편찬위원회 실록원문 벌크 XML(2022-11-03)의 `wja` 계열 파일을 모은 판본이다.
원문 사료와 수정·보완본을 별도 Source로 둔다. 원문을 합치거나 옳고 그름을 정하지 않는다.

## 연도 근거

[국가기록원 실록 일람표](https://theme.archives.go.kr/next/sillok/sub2_2.do)의 수록 기간 1494~1506, 편찬 연도 1509를 따른다.
...
chunk 가 놓인 층: level2 14 · level3 146 · level5 12,009. 연대(dateOccured) 붙은 chunk 12,022, 본문이 빈 chunk 0, 본문 글자 수 1,945,506.
주석 1,643(교감주 1,621 · 원주 22), 색인어 62,193(이름 48,674 · 지명 11,788 · 서명 1,613 · 연호 118).
<!-- counts:end -->

숫자는 `scripts/fill_card_counts.py --source sillok-wja`와 같은 코드로 센다.
