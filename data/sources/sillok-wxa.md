...
국사편찬위원회 실록원문 벌크 XML(2022-11-03)의 `wxa` 계열 파일을 모은 판본이다.
원문 사료와 수정·보완본을 별도 Source로 둔다. 원문을 합치거나 옳고 그름을 정하지 않는다.

## 연도 근거

[국가기록원 실록 일람표](https://theme.archives.go.kr/next/sillok/sub2_2.do)의 수록 기간 1834~1849, 편찬 연도 1851를 따른다.
...
chunk 가 놓인 층: level2 18 · level3 189 · level5 3,979. 연대(dateOccured) 붙은 chunk 3,995, 본문이 빈 chunk 0, 본문 글자 수 245,082.
주석 146(원주 97 · 교감주 49), 색인어 9,010(이름 5,072 · 지명 3,811 · 서명 105 · 연호 22).
<!-- counts:end -->

숫자는 `scripts/fill_card_counts.py --source sillok-wxa`와 같은 코드로 센다.
