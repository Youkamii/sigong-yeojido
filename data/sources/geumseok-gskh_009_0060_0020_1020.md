---
type: "Source"
id: "src-geumseok-gskh_009_0060_0020_1020"
label: "정시9년명 전"
labelHanja: "正始九年銘 塼"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
...
sourceLevelId: "gskh_009_0060_0020_1020"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0060_0020_1020`. 경로: 낙랑 › 와명·전명·토기명 › 전명 › 정시9년명 전.
...
XML 날짜: `0248-99-99` — 248년(위(魏) 제왕(齊王) 정시(正始)9년).
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 황해남도(구 황해도) 신천군(信川郡) 봉황리(鳳凰里) 왕경묘(王卿墓).
크기: 예서체(隷書體) / 흙. 서체: 와명·전명.
[국편 항목](https://db.history.go.kr/id/gskh_009_0060_0020_1020)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,762.
주석 6(각주 6), 색인어 9(이름 5 · 관직 2 · 지명 2).
<!-- counts:end -->
