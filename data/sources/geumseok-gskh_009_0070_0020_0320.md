---
type: "Source"
id: "src-geumseok-gskh_009_0070_0020_0320"
label: "영광원년명 이배(1)"
labelHanja: "永光元年銘 耳杯(1)"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
composedYear: null
coversFrom: null
...
sourceLevelId: "gskh_009_0070_0020_0320"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0070_0020_0320`. 경로: 낙랑 › 칠기명 › 기년명 칠기 › 영광원년명 이배(1).
...
XML 날짜: `9999-99-99` — BC43년(전한(前漢) 원제(元帝) 영광(永光)원년).
...
출토·소재지 원표기: 북한. 소장처: 평양시 락랑구역(樂浪區域) 정백동(貞柏洞, 구 정백리).
크기: 없음. 서체: 나무.
[국편 항목](https://db.history.go.kr/id/gskh_009_0070_0020_0320)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,172.
주석 7(각주 7), 색인어 9(관직 4 · 이름 4 · 관서 1).
<!-- counts:end -->
