...
국사편찬위원회 실록원문 벌크 XML(2022-11-03)의 `wqa` 계열 파일을 모은 판본이다.
원문 사료와 수정·보완본을 별도 Source로 둔다. 원문을 합치거나 옳고 그름을 정하지 않는다.

## 연도 근거

[국가기록원 실록 일람표](https://theme.archives.go.kr/next/sillok/sub2_2.do)의 수록 기간 1649~1659, 편찬 연도 1661를 따른다.
...
chunk 가 놓인 층: level2 13 · level3 130 · level5 5,427. 연대(dateOccured) 붙은 chunk 5,438, 본문이 빈 chunk 0, 본문 글자 수 1,275,082.
주석 597(원주 511 · 교감주 86), 색인어 31,075(이름 24,176 · 지명 4,866 · 서명 1,966 · 연호 67).
<!-- counts:end -->

숫자는 `scripts/fill_card_counts.py --source sillok-wqa`와 같은 코드로 센다.
