---
type: "Source"
id: "src-geumseok-gskh_006_0080_0010"
label: "발해 전명"
labelHanja: "渤海 塼銘"
sourceKind: "금석문"
sourceGroup: "금석문 · 발해"
...
sourceLevelId: "gskh_006_0080_0010"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_006_0080_0010`. 경로: 발해 › 와명·전명 › 발해 전명.
...
출토·소재지 원표기: 중국 길림성(吉林省) 화룡현(和龍縣) 용수향(龍水鄕) 용해촌(龍海村) 서쪽 용두산(龍頭山) 정효공주 무덤 탑 기초 부분. 소장처: 중국 연변박물관.
크기: 길이 33cm, 너비 16.5cm, 두께 5.8cm (회방우엄명 전) / 길이 30cm, 두께 5.5cm (난서명 전) / 길이 15.5cm, 두께 6cm (시요산효명 전). 서체: 난서명전 : 초서(草書) / 흙(흙벽돌).
[국편 항목](https://db.history.go.kr/id/gskh_006_0080_0010)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 2. 연대(dateOccured) 붙은 chunk 0, 본문이 빈 chunk 0, 본문 글자 수 1,319.
주석 0(), 색인어 0().
<!-- counts:end -->
