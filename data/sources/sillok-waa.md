...
국사편찬위원회 실록원문 벌크 XML(2022-11-03)의 `waa` 계열 파일을 모은 판본이다.
원문 사료와 수정·보완본을 별도 Source로 둔다. 원문을 합치거나 옳고 그름을 정하지 않는다.

## 연도 근거

[국가기록원 실록 일람표](https://theme.archives.go.kr/next/sillok/sub2_2.do)의 수록 기간 1392~1398, 편찬 연도 1413를 따른다.
...
chunk 가 놓인 층: level2 9 · level3 217 · level5 2,251. 연대(dateOccured) 붙은 chunk 2,258, 본문이 빈 chunk 0, 본문 글자 수 266,797.
주석 178(교감주 97 · 원주 81), 색인어 12,386(이름 8,248 · 지명 3,841 · 서명 191 · 연호 106).
<!-- counts:end -->

숫자는 `scripts/fill_card_counts.py --source sillok-waa`와 같은 코드로 센다.
