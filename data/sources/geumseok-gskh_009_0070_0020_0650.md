---
type: "Source"
id: "src-geumseok-gskh_009_0070_0020_0650"
label: "칠반 잔결(4)"
labelHanja: "漆盤 殘缺(4)"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
...
sourceLevelId: "gskh_009_0070_0020_0650"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0070_0020_0650`. 경로: 낙랑 › 칠기명 › 기년명 칠기 › 칠반 잔결(4).
...
XML 날짜: `9999-99-99` — BC16년(전한(前漢) 성제(成帝) 영시(永始)원년) 전후.
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 평안남도 평원군 평원명(구 대동군(大同郡) 대동강면(大同江面)) 석암리(石巖里) 260호분.
크기: 없음. 서체: 나무.
[국편 항목](https://db.history.go.kr/id/gskh_009_0070_0020_0650)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,097.
주석 0(), 색인어 14(관직 8 · 이름 6).
<!-- counts:end -->
