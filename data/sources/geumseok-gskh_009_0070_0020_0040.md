---
type: "Source"
id: "src-geumseok-gskh_009_0070_0020_0040"
label: "거섭3년명 칠반(3)"
labelHanja: "居攝三年銘 漆盤(3)"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
composedYear: 8
coversFrom: 8
...
sourceLevelId: "gskh_009_0070_0020_0040"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0070_0020_0040`. 경로: 낙랑 › 칠기명 › 기년명 칠기 › 거섭3년명 칠반(3).
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 평안남도 평원군 평원면(구 대동군(大同郡) 대동강면(大同江面)) 석암리(石巖里) 9호분.
크기: 없음. 서체: 나무.
[국편 항목](https://db.history.go.kr/id/gskh_009_0070_0020_0040)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,253.
주석 1(각주 1), 색인어 25(관직 12 · 이름 12 · 관서 1).
<!-- counts:end -->
