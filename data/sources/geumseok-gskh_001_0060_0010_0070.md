---
type: "Source"
id: "src-geumseok-gskh_001_0060_0010_0070"
label: "「정사」명 와당"
labelHanja: "「丁巳」銘 瓦壋"
sourceKind: "금석문"
sourceGroup: "금석문 · 고구려"
...
sourceLevelId: "gskh_001_0060_0010_0070"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_001_0060_0010_0070`. 경로: 고구려 › 와명·전명 › 중국 집안지역 출토 와명 › 「정사」명 와당.
...
XML 날짜: `0357-99-99` — 故國原王 二七年(三五七) 推定.
...
출토·소재지 원표기: 中國 吉林省 集安縣 禹山墓區 M3319 方檀階梯積石墓. 소장처: 없음.
크기: 徑16.5cm、厚2~2.5cm. 서체: 隷書.
[국편 항목](https://db.history.go.kr/id/gskh_001_0060_0010_0070)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 6. 연대(dateOccured) 붙은 chunk 4, 본문이 빈 chunk 0, 본문 글자 수 560.
주석 0(), 색인어 0().
<!-- counts:end -->
