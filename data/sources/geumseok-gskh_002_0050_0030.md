---
type: "Source"
id: "src-geumseok-gskh_002_0050_0030"
label: "스다하치만신사 인물화상경"
labelHanja: "隅田八幡神社人物畵像鏡"
sourceKind: "금석문"
sourceGroup: "금석문 · 백제"
composedYear: null
coversFrom: 400
...
sourceLevelId: "gskh_002_0050_0030"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_002_0050_0030`. 경로: 백제 › 금속기명 › 스다하치만신사 인물화상경.
...
출토·소재지 원표기: 일본 화가산현(和歌山縣) 교본시(橋本市) 우전팔번신사(隅田八幡神社). 소장처: 일본 화가산현(和歌山縣) 교본시(橋本市) 소재 고분.
크기: 지름 20cm. 서체: 동.
[국편 항목](https://db.history.go.kr/id/gskh_002_0050_0030)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,201.
주석 8(각주 8), 색인어 1(이름 1).
<!-- counts:end -->
