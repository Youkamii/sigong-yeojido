---
type: "Source"
id: "src-geumseok-gskh_009_0030_0180"
label: "「왕야지인」명 동인"
labelHanja: "「王野之印」銘 銅印"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
composedYear: null
coversFrom: null
...
sourceLevelId: "gskh_009_0030_0180"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0030_0180`. 경로: 낙랑 › 인장명 › 「왕야지인」명 동인.
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 평안남도 평원군 평원면(구 대동군(大同郡) 대동강면(大同江面)) 석암리(石巖里) 219호분.
크기: 인면(印面) 1.61cm 방형(方形). 서체: 전서체(篆書體) / 동.
[국편 항목](https://db.history.go.kr/id/gskh_009_0030_0180)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 2, 본문이 빈 chunk 0, 본문 글자 수 919.
주석 1(각주 1), 색인어 1(이름 1).
<!-- counts:end -->
