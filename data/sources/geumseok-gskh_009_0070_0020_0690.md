---
type: "Source"
id: "src-geumseok-gskh_009_0070_0020_0690"
label: "칠반편(3)"
labelHanja: "漆盤片(3)"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
...
sourceLevelId: "gskh_009_0070_0020_0690"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0070_0020_0690`. 경로: 낙랑 › 칠기명 › 기년명 칠기 › 칠반편(3).
...
XML 날짜: `0008-99-99` — 8년(전한(前漢) 유자영(孺子瓔) 거섭(居攝)3년) 추정.
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 평양시 락랑구역(樂浪區域) 오야리(梧野里) 낙랑고분.
크기: 없음. 서체: 나무.
[국편 항목](https://db.history.go.kr/id/gskh_009_0070_0020_0690)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,027.
주석 0(), 색인어 17(관직 8 · 이름 8 · 관서 1).
<!-- counts:end -->
