---
type: "Source"
id: "src-geumseok-gskh_010_0060_0060"
label: "「진솔선예백장」명 동인"
labelHanja: "「晉率善穢佰長」銘 銅印"
sourceKind: "금석문"
...
sourceLevelId: "gskh_010_0060_0060"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_010_0060_0060`. 경로: 중국계 금석문 › 인장명 › 「진솔선예백장」명 동인.
...
출토·소재지 원표기: 삼성미술관 리움. 소장처: 경상북도 영일군 신광면 마조리.
크기: 가로 2.2cm, 세로 2.2cm, 높이 2.5cm. 서체: 전서(篆書).
[국편 항목](https://db.history.go.kr/id/gskh_010_0060_0060)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,564.
주석 8(각주 8), 색인어 0().
<!-- counts:end -->
