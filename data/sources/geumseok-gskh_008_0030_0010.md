---
type: "Source"
id: "src-geumseok-gskh_008_0030_0010"
label: "부여씨조상감기"
labelHanja: "扶餘氏造像龕記"
sourceKind: "금석문"
...
sourceLevelId: "gskh_008_0030_0010"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_008_0030_0010`. 경로: 백제 유민 관련 금석문 › 석각 › 부여씨조상감기.
...
XML 날짜: `0680-99-99` — 680년(신라 문무왕 20) 이후.
...
출토·소재지 원표기: 中國 河南省 洛陽市 龍門石窟. 소장처: 없음.
크기: 미상(未詳). 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_008_0030_0010)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,364.
주석 2(각주 2), 색인어 0().
<!-- counts:end -->
