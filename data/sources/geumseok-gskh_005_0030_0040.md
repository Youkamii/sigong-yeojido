---
type: "Source"
id: "src-geumseok-gskh_005_0030_0040"
label: "경주 관문 산성 석각"
labelHanja: "慶州 關門 山城 石刻"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0030_0040"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0030_0040`. 경로: 통일신라 › 석각 › 경주 관문 산성 석각.
...
XML 날짜: `9999-99-99` — 7세기 후반 : 관문 산성.
...
출토·소재지 원표기: 경상북도 경주시 외동면 해발 590m. 소장처: 없음.
크기: 없음. 서체: 해서체(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_005_0030_0040)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 4,346.
주석 12(각주 12), 색인어 0().
<!-- counts:end -->
