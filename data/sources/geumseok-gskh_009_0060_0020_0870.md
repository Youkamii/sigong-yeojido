---
type: "Source"
id: "src-geumseok-gskh_009_0060_0020_0870"
label: "건원3년명 전"
labelHanja: "建元三年銘 塼"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
...
sourceLevelId: "gskh_009_0060_0020_0870"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0060_0020_0870`. 경로: 낙랑 › 와명·전명·토기명 › 전명 › 건원3년명 전.
...
XML 날짜: `03##-99-99` — 345년(동진(東晉) 강제(康帝) 건원(建元)3년) 추정.
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 황해남도(구 황해도) 신천군(信川郡) 가산면(加山面) 간성리(干城里) / 황해남도(구 황해도) 신천군 용문면(龍門面) 복우리(福隅里).
크기: 측면 35×5cm. 서체: 예서(隷書) / 흙.
[국편 항목](https://db.history.go.kr/id/gskh_009_0060_0020_0870)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,560.
주석 3(각주 3), 색인어 1(이름 1).
<!-- counts:end -->
