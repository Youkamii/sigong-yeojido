---
type: "Source"
id: "src-geumseok-gskh_002_0060_0020_0040"
label: "「갈야성」명 와"
labelHanja: "「葛耶城」銘 瓦"
sourceKind: "금석문"
sourceGroup: "금석문 · 백제"
...
sourceLevelId: "gskh_002_0060_0020_0040"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_002_0060_0020_0040`. 경로: 백제 › 와명·전명 › 부여지역 출토 와전명 › 「갈야성」명 와.
...
출토·소재지 원표기: 국립부여박물관. 소장처: 전라북도 익산시 왕궁면 왕궁리 왕궁평성.
크기: 없음. 서체: 해서(楷書) / 흙.
[국편 항목](https://db.history.go.kr/id/gskh_002_0060_0020_0040)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 182.
주석 0(), 색인어 1(지명 1).
<!-- counts:end -->
