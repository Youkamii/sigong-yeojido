---
type: "Source"
id: "src-geumseok-gskh_009_0040_0010"
label: "「유주자사」명 봉니"
labelHanja: "「幽州刺史」銘 封泥"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
composedYear: null
coversFrom: null
...
sourceLevelId: "gskh_009_0040_0010"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0040_0010`. 경로: 낙랑 › 봉니명 › 「유주자사」명 봉니.
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 낙랑지역(평양시 남쪽 토성지).
크기: 인면(印面) 방(方) 약 2.18cm. 서체: 흙.
[국편 항목](https://db.history.go.kr/id/gskh_009_0040_0010)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 541.
주석 1(각주 1), 색인어 1(관직 1).
<!-- counts:end -->
