---
type: "Source"
id: "src-geumseok-gskh_007_0010_0090"
label: "고제석 묘지명"
labelHanja: "高提昔 墓誌銘"
sourceKind: "금석문"
...
sourceLevelId: "gskh_007_0010_0090"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_007_0010_0090`. 경로: 고구려 유민 관련 금석문 › 묘지명 › 고제석 묘지명.
...
XML 날짜: `0674-06-04` — 사망일 : 674년(당 咸亨 4년) 6월 4일; 장례일 : 674년(당 上元 원년) 8월 25일.
...
출토·소재지 원표기: 미상(未詳). 소장처: 中國 陜西省 西安市 東郊의 龍首原.
크기: 개석(蓋石)과 지석(誌石) : 정방형, 한 변 38㎝. 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_007_0010_0090)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 3,283.
주석 6(각주 6), 색인어 0().
<!-- counts:end -->
