---
type: "Source"
id: "src-geumseok-gskh_009_0060_0020_1150"
label: "태시4년명 전"
labelHanja: "泰始四年銘 塼"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
...
sourceLevelId: "gskh_009_0060_0020_1150"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0060_0020_1150`. 경로: 낙랑 › 와명·전명·토기명 › 전명 › 태시4년명 전.
...
XML 날짜: `0268-99-99` — 268년(진(晉) 무제(武帝) 태시(泰始)4년).
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 황해남도(구 황해도) 신천군(信川郡) 가산면(加山面) 간성리(干城里).
크기: 없음. 서체: 흙.
[국편 항목](https://db.history.go.kr/id/gskh_009_0060_0020_1150)의 id를 연결 정보로 보존했다.
