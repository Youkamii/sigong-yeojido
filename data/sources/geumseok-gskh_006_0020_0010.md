---
type: "Source"
id: "src-geumseok-gskh_006_0020_0010"
label: "일본 정창원 악구궐실병출납장"
labelHanja: "日本 正倉院 樂具闕失幷出納帳"
sourceKind: "금석문"
sourceGroup: "금석문 · 발해"
composedYear: 763
coversFrom: 763
...
sourceLevelId: "gskh_006_0020_0010"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_006_0020_0010`. 경로: 발해 › 고문서 › 일본 정창원 악구궐실병출납장.
...
XML 날짜: `0763-99-99` — 日本 天平寶字 七年(七六三).
...
출토·소재지 원표기: 日本 東大寺 正倉院. 소장처: 없음.
크기: 없음. 서체: 없음.
[국편 항목](https://db.history.go.kr/id/gskh_006_0020_0010)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 902.
주석 0(), 색인어 2(관직 1 · 이름 1).
<!-- counts:end -->
