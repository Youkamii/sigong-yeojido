---
type: "Source"
id: "src-geumseok-gskh_005_0040_0100"
label: "남원 실상사 편운화상 승탑"
labelHanja: "南原 實相寺 片雲和尙 僧塔"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0040_0100"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0040_0100`. 경로: 통일신라 › 탑명·등명 › 남원 실상사 편운화상 승탑.
...
XML 날짜: `0910-99-99` — 910년 (후백제 견훤 19년, 신라 효공왕 14년).
...
출토·소재지 원표기: 전라북도 남원시 산내면 입석리 산3 실상사 조계암지. 소장처: 없음.
크기: 높이 182㎝, 탑신의 폭 57.5㎝. 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_005_0040_0100)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,986.
주석 7(각주 7), 색인어 0().
<!-- counts:end -->
