---
type: "Source"
id: "src-geumseok-gskh_009_0060_0020_1230"
label: "함녕원년명 전(2)"
labelHanja: "咸寧元年銘 塼(2)"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
composedYear: null
coversFrom: 200
...
sourceLevelId: "gskh_009_0060_0020_1230"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0060_0020_1230`. 경로: 낙랑 › 와명·전명·토기명 › 전명 › 함녕원년명 전(2).
...
XML 날짜: `02##-99-99` — 275년(진(晉) 무제(武帝) 함령(咸寧)원년) 추정.
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 황해남도(구 황해도) 신천군(信川郡).
크기: 측면 30×4.5~5cm. 서체: 예서체(隷書體) / 흙.
[국편 항목](https://db.history.go.kr/id/gskh_009_0060_0020_1230)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,561.
주석 2(각주 2), 색인어 1(관직 1).
<!-- counts:end -->
