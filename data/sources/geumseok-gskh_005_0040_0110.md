---
type: "Source"
id: "src-geumseok-gskh_005_0040_0110"
label: "합천 해인사 길상탑지"
labelHanja: "陜川 海印寺 吉祥塔誌"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0040_0110"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0040_0110`. 경로: 통일신라 › 탑명·등명 › 합천 해인사 길상탑지.
...
XML 날짜: `0695-99-99` — 895년(신라 진성왕 9).
...
출토·소재지 원표기: 경상남도 합천군 가야면 해인사길 122 해인사. 소장처: 서울특별시 용산구 서빙고로 137 국립중앙박물관.
크기: 가로 23.2㎝, 세로 23.2㎝, 두께 2.5㎝, 글자크기 1~1.5㎝. 서체: 해서.
[국편 항목](https://db.history.go.kr/id/gskh_005_0040_0110)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 7,345.
주석 87(각주 83 · 소자쌍행 4), 색인어 0().
<!-- counts:end -->
