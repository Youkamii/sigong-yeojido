---
type: "Source"
id: "src-geumseok-gskh_010_0030_0010"
label: "익산 출토 동경"
labelHanja: "益山 出土 銅鏡"
sourceKind: "금석문"
...
sourceLevelId: "gskh_010_0030_0010"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_010_0030_0010`. 경로: 중국계 금석문 › 동경명 › 익산 출토 동경.
...
출토·소재지 원표기: 국립 부여박물관. 소장처: 전라북도 익산시 삼기면 연동리 태봉사(胎峯寺) 부지.
크기: 직경 14.3cm, 높이 1.1.cm. 서체: 예서.
[국편 항목](https://db.history.go.kr/id/gskh_010_0030_0010)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,895.
주석 7(각주 7), 색인어 0().
<!-- counts:end -->
