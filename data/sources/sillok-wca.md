...
국사편찬위원회 실록원문 벌크 XML(2022-11-03)의 `wca` 계열 파일을 모은 판본이다.
원문 사료와 수정·보완본을 별도 Source로 둔다. 원문을 합치거나 옳고 그름을 정하지 않는다.

## 연도 근거

[국가기록원 실록 일람표](https://theme.archives.go.kr/next/sillok/sub2_2.do)의 수록 기간 1401~1418, 편찬 연도 1431를 따른다.
...
chunk 가 놓인 층: level2 20 · level3 220 · level5 10,336. 연대(dateOccured) 붙은 chunk 10,354, 본문이 빈 chunk 0, 본문 글자 수 1,462,413.
주석 803(교감주 720 · 원주 83), 색인어 57,045(이름 39,966 · 지명 15,526 · 서명 1,237 · 연호 316).
<!-- counts:end -->

숫자는 `scripts/fill_card_counts.py --source sillok-wca`와 같은 코드로 센다.
