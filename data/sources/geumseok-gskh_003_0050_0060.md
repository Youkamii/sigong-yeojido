---
type: "Source"
id: "src-geumseok-gskh_003_0050_0060"
label: "「고덕흥」명 청동초두"
labelHanja: "「高德興」銘 靑銅鐎斗"
sourceKind: "금석문"
sourceGroup: "금석문 · 신라"
composedYear: null
coversFrom: null
...
sourceLevelId: "gskh_003_0050_0060"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_003_0050_0060`. 경로: 신라 › 금속기명 › 「고덕흥」명 청동초두.
...
출토·소재지 원표기: 國立慶州博物館. 소장처: 慶州皇吾里一七號墳 出土.
크기: 높이 11cm、입지름 18.8cm、전체길이 38cm、글자크기 1.5cm. 서체: 長柄下面 에 細線 陰刻.
[국편 항목](https://db.history.go.kr/id/gskh_003_0050_0060)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 6. 연대(dateOccured) 붙은 chunk 4, 본문이 빈 chunk 0, 본문 글자 수 727.
주석 1(각주 1), 색인어 0().
<!-- counts:end -->
