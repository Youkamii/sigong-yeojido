---
type: "Source"
id: "src-geumseok-gskh_008_0010_0070"
label: "예인수 묘지명"
labelHanja: "禰仁秀 墓誌銘"
sourceKind: "금석문"
...
sourceLevelId: "gskh_008_0010_0070"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_008_0010_0070`. 경로: 백제 유민 관련 금석문 › 묘지명 › 예인수 묘지명.
...
XML 날짜: `0750-99-99` — 750년(唐 天寶 9년).
...
출토·소재지 원표기: 中國 西安市 文物保護考古硏究院. 소장처: 中國 西安市 長安區 郭杜鎭南村.
크기: (개석) 가로 52cm, 세로 52cm, 두께 6.5cm; (지석) 가로 52cm, 세로 52cm, 두께 16cm. 서체: (개석) 해서체 ; (지석) 해서체.
[국편 항목](https://db.history.go.kr/id/gskh_008_0010_0070)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 5,984.
주석 79(각주 79), 색인어 0().
<!-- counts:end -->
