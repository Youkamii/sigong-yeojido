---
type: "Source"
id: "src-geumseok-gskh_009_0060_0020_0890"
label: "경원원년명 전"
labelHanja: "景元元年銘 塼"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
...
sourceLevelId: "gskh_009_0060_0020_0890"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0060_0020_0890`. 경로: 낙랑 › 와명·전명·토기명 › 전명 › 경원원년명 전.
...
XML 날짜: `0260-99-99` — 260년(위(魏) 원제(元帝) 경원(景元)원년).
...
크기: 측면 32.5×6.0cm. 서체: 예서체(隷書體) / 흙.
[국편 항목](https://db.history.go.kr/id/gskh_009_0060_0020_0890)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,552.
주석 1(각주 1), 색인어 0().
<!-- counts:end -->
