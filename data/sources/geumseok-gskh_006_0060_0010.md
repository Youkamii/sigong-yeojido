---
type: "Source"
id: "src-geumseok-gskh_006_0060_0010"
label: "일본 다가죠비"
labelHanja: "日本 多賀城碑"
sourceKind: "금석문"
sourceGroup: "금석문 · 발해"
...
sourceLevelId: "gskh_006_0060_0010"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_006_0060_0010`. 경로: 발해 › 비문 › 일본 다가죠비.
...
출토·소재지 원표기: 일본 본주(本州) 궁성현(宮城縣) 다하성시(多賀城市) 다하성 남쪽 작은 언덕. 소장처: 일본 본주(本州) 궁성현(宮城縣) 다하성시(多賀城市) 다하성 남쪽 작은 언덕.
크기: 높이 196cm, 비면 최대 너비 92cm, 최대 두께 70cm. 서체: 해서 중심, 행서와 이체자(異體字) 섞여있음 / 사암(砂岩).
[국편 항목](https://db.history.go.kr/id/gskh_006_0060_0010)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,587.
주석 0(), 색인어 11(관직 5 · 지명 4 · 이름 2).
<!-- counts:end -->
