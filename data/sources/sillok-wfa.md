...
국사편찬위원회 실록원문 벌크 XML(2022-11-03)의 `wfa` 계열 파일을 모은 판본이다.
원문 사료와 수정·보완본을 별도 Source로 둔다. 원문을 합치거나 옳고 그름을 정하지 않는다.

## 연도 근거

[국가기록원 실록 일람표](https://theme.archives.go.kr/next/sillok/sub2_2.do)의 수록 기간 1452~1455, 편찬 연도 1469를 따른다.
...
chunk 가 놓인 층: level2 6 · level3 54 · level5 2,532. 연대(dateOccured) 붙은 chunk 2,536, 본문이 빈 chunk 0, 본문 글자 수 506,727.
주석 771(원주 514 · 교감주 257), 색인어 21,288(이름 15,568 · 지명 5,200 · 서명 425 · 연호 95).
<!-- counts:end -->

숫자는 `scripts/fill_card_counts.py --source sillok-wfa`와 같은 코드로 센다.
