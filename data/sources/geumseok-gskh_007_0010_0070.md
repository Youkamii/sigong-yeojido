---
type: "Source"
id: "src-geumseok-gskh_007_0010_0070"
label: "고을덕 묘지명"
labelHanja: "高乙德 墓誌銘"
sourceKind: "금석문"
...
sourceLevelId: "gskh_007_0010_0070"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_007_0010_0070`. 경로: 고구려 유민 관련 금석문 › 묘지명 › 고을덕 묘지명.
...
XML 날짜: `0699-02-08` — 사망일 : 699년(聖曆 2년) 2월 8일; 장례일 : 701년(大足 원년) 9월 28일.
...
출토·소재지 원표기: 中國 河南省 洛陽市의 고미술상(추정). 소장처: 中國 陝西省 西安市 동남 杜陵의 북쪽(추정).
크기: 지석(誌石) : 길이와 너비 약 37~38㎝; 개석(蓋石) : 미상. 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_007_0010_0070)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 6,042.
주석 32(각주 22 · 소자쌍행 10), 색인어 0().
<!-- counts:end -->
