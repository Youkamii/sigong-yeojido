---
type: "Source"
id: "src-geumseok-gskh_006_0100_0010"
label: "장벽 영광탑 명문"
labelHanja: "長白 靈光塔 銘文"
sourceKind: "금석문"
sourceGroup: "금석문 · 발해"
composedYear: null
coversFrom: null
...
sourceLevelId: "gskh_006_0100_0010"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_006_0100_0010`. 경로: 발해 › 탑명·등명 › 장벽 영광탑 명문.
...
출토·소재지 원표기: 중국 길림성(吉林省) 장백조선족자치현(長白朝鮮族自治縣) 소재 영광탑. 소장처: 중국 길림성(吉林省) 장백조선족자치현(長白朝鮮族自治縣) 소재 영광탑.
크기: 전체 높이 13m. 서체: 흙(흙벽돌).
[국편 항목](https://db.history.go.kr/id/gskh_006_0100_0010)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 2. 연대(dateOccured) 붙은 chunk 0, 본문이 빈 chunk 0, 본문 글자 수 678.
주석 0(), 색인어 0().
<!-- counts:end -->
