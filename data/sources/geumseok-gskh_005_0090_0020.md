---
type: "Source"
id: "src-geumseok-gskh_005_0090_0020"
label: "경주 석장사지 출토 탑상문전명"
labelHanja: "慶州 錫杖寺址 出土 塔像紋塼銘"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0090_0020"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0090_0020`. 경로: 통일신라 › 와명·전명 › 경주 석장사지 출토 탑상문전명.
...
출토·소재지 원표기: 없음. 소장처: 慶州市 金文洞 錫杖寺址 出土.
크기: 높이 8cm、폭 6.5cm、두께 2cm、 글자크기 약 0.5cm. 서체: 楷書.
[국편 항목](https://db.history.go.kr/id/gskh_005_0090_0020)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 2. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 101.
주석 0(), 색인어 0().
<!-- counts:end -->
