---
type: "Source"
id: "src-geumseok-gskh_005_0070_0030"
label: "성덕대왕신종명"
labelHanja: "聖德大王神鍾銘"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0070_0030"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0070_0030`. 경로: 통일신라 › 종명·금구명 › 성덕대왕신종명.
...
XML 날짜: `0771-99-99` — 771년(신라 혜공왕 7).
...
출토·소재지 원표기: 경상북도 경주시 일정로 186, 국립경주박물관. 소장처: 없음.
크기: 총 높이 366㎝, 종신 286.4㎝, 입지름 227㎝, 두께 11∼25㎝, 무게 18.9톤. 서체: 서문(序文)-해서 / 사(詞)-행서.
[국편 항목](https://db.history.go.kr/id/gskh_005_0070_0030)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 9,536.
주석 171(각주 171), 색인어 0().
<!-- counts:end -->
