---
type: "Source"
id: "src-geumseok-gskh_002_0070_0010"
label: "고창 오호리 청동인장"
labelHanja: "高敞 五湖里 靑銅印章"
sourceKind: "금석문"
sourceGroup: "금석문 · 백제"
composedYear: 525
coversFrom: 525
...
sourceLevelId: "gskh_002_0070_0010"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_002_0070_0010`. 경로: 백제 › 인장명 › 고창 오호리 청동인장.
...
XML 날짜: `0525-99-99` — 6세기 초(525년 이후).
...
출토·소재지 원표기: 전라북도 고창군 오호리 신지매 유적. 소장처: 없음.
크기: 가로 2.7㎝, 세로 2.5㎝, 전체높이 2.9㎝, 도장면높이 1.1㎝, 손잡이높이 1.8㎝. 서체: 전서(篆書).
[국편 항목](https://db.history.go.kr/id/gskh_002_0070_0010)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 953.
주석 1(각주 1), 색인어 0().
<!-- counts:end -->
