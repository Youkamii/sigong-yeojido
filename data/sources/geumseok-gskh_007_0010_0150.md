---
type: "Source"
id: "src-geumseok-gskh_007_0010_0150"
label: "남단덕 묘지명"
labelHanja: "南單德 墓誌銘"
sourceKind: "금석문"
...
sourceLevelId: "gskh_007_0010_0150"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_007_0010_0150`. 경로: 고구려 유민 관련 금석문 › 묘지명 › 남단덕 묘지명.
...
XML 날짜: `0776-99-99` — 776년(唐 大曆 11년).
...
출토·소재지 원표기: 中國 西安 碑林博物館. 소장처: 中國 陝西省 西安市 灞橋區 紅旗鄕.
크기: (지석) 가로 44.2cm, 세로 43.5cm, 두께 7.5cm. 서체: (지석) 해서체.
[국편 항목](https://db.history.go.kr/id/gskh_007_0010_0150)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 5,841.
주석 70(각주 64 · 소자쌍행 6), 색인어 0().
<!-- counts:end -->
