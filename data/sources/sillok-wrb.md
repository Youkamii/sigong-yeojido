...
국사편찬위원회 실록원문 벌크 XML(2022-11-03)의 `wrb` 계열 파일을 모은 판본이다.
원문 사료와 수정·보완본을 별도 Source로 둔다. 원문을 합치거나 옳고 그름을 정하지 않는다.

## 연도 근거

[국가기록원 실록 일람표](https://theme.archives.go.kr/next/sillok/sub2_2.do)의 수록 기간 1659~1674, 편찬 연도 1683를 따른다.
...
chunk 가 놓인 층: level2 17 · level3 193 · level5 10,502. 연대(dateOccured) 붙은 chunk 10,518, 본문이 빈 chunk 0, 본문 글자 수 1,898,851.
주석 1,146(교감주 887 · 원주 259), 색인어 55,747(이름 44,276 · 지명 10,393 · 서명 994 · 연호 84).
<!-- counts:end -->

숫자는 `scripts/fill_card_counts.py --source sillok-wrb`와 같은 코드로 센다.
