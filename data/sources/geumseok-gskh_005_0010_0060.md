---
type: "Source"
id: "src-geumseok-gskh_005_0010_0060"
label: "경주 찬지비"
labelHanja: "慶州 飡之碑"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0010_0060"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0010_0060`. 경로: 통일신라 › 비문 › 경주 찬지비.
...
크기: (1)은 길이 39.5cm、폭 33cm、두께 26cm、(2)는 길이 55cm、폭 38.5cm、두께 26.5cm、. 서체: 行書.
[국편 항목](https://db.history.go.kr/id/gskh_005_0010_0060)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 6. 연대(dateOccured) 붙은 chunk 4, 본문이 빈 chunk 0, 본문 글자 수 1,135.
주석 1(각주 1), 색인어 0().
<!-- counts:end -->
