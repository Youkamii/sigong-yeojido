---
type: "Source"
id: "src-geumseok-gskh_005_0040_0080"
label: "경주 선방사 탑지"
labelHanja: "慶州 禪房寺 塔誌"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0040_0080"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0040_0080`. 경로: 통일신라 › 탑명·등명 › 경주 선방사 탑지.
...
XML 날짜: `0879-99-99` — 879년(신라 헌강왕 5년).
...
출토·소재지 원표기: 불명(不明). 소장처: 경상북도 경주시 배동 산 65-1 선방곡 제1사지.
크기: 높이 약 9.09㎝, 폭 약 6.36㎝, 두께 약 4.55㎝. 서체: 해서.
[국편 항목](https://db.history.go.kr/id/gskh_005_0040_0080)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,653.
주석 11(각주 11), 색인어 0().
<!-- counts:end -->
