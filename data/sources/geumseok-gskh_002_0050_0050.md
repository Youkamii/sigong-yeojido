---
type: "Source"
id: "src-geumseok-gskh_002_0050_0050"
label: "익산 미륵사지 서탑 출토 금제소형판"
labelHanja: "益山 彌勒寺址 西塔 出土 金製小形板"
sourceKind: "금석문"
sourceGroup: "금석문 · 백제"
composedYear: 639
coversFrom: 639
...
sourceLevelId: "gskh_002_0050_0050"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_002_0050_0050`. 경로: 백제 › 금속기명 › 익산 미륵사지 서탑 출토 금제소형판.
...
XML 날짜: `0639-99-99` — 639년(백제 무왕 40).
...
출토·소재지 원표기: 전라북도 익산시 미륵사지로 362(금마면, 국립미륵사지유물전시관). 소장처: 없음.
크기: (금제소형판6) 길이 8.14㎝, 너비 1.24㎝, 두께 1㎝; (금제소형판12) 길이 7.76㎝, 너비 1.21㎝, 두께 1㎝; (금제소형판14) 길이 8.26㎝, 너비 1.34㎝, 두께 0.7㎝. 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_002_0050_0050)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,414.
주석 4(각주 4), 색인어 0().
<!-- counts:end -->
