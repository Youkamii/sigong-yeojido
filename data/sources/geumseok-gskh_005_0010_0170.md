---
type: "Source"
id: "src-geumseok-gskh_005_0010_0170"
label: "백률사 석당기"
labelHanja: "栢栗寺石幢記"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0010_0170"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0010_0170`. 경로: 통일신라 › 비문 › 백률사 석당기.
...
XML 날짜: `0818-99-99` — 憲德王 一○年(八一八)으로 추정.
...
출토·소재지 원표기: 國立慶州博物館(原 慶州 栢栗寺址). 소장처: 없음.
크기: 높이 105cm、폭 29cm、글자크기 3cm. 서체: 楷書.
[국편 항목](https://db.history.go.kr/id/gskh_005_0010_0170)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 12. 연대(dateOccured) 붙은 chunk 9, 본문이 빈 chunk 0, 본문 글자 수 11,040.
주석 26(각주 26), 색인어 69(이름 60 · 지명 9).
<!-- counts:end -->
