---
type: "Source"
id: "src-geumseok-gskh_004_0030_0010"
label: "합천 저포리 출토 토기 명문"
labelHanja: "陜川 苧浦里 出土 土器 銘文"
sourceKind: "금석문"
sourceGroup: "금석문 · 가야"
composedYear: null
coversFrom: 500
...
sourceLevelId: "gskh_004_0030_0010"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_004_0030_0010`. 경로: 가야 › 토기명 › 합천 저포리 출토 토기 명문.
...
출토·소재지 원표기: 부산대학교 박물관. 소장처: 陜川 苧浦里 E지구 제4-1호분에서 출토.
크기: 글자크기 약 1cm. 서체: 楷書.
[국편 항목](https://db.history.go.kr/id/gskh_004_0030_0010)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 5. 연대(dateOccured) 붙은 chunk 3, 본문이 빈 chunk 0, 본문 글자 수 588.
주석 2(각주 2), 색인어 2(이름 2).
<!-- counts:end -->
