---
type: "Source"
id: "src-geumseok-gskh_002_0060_0030_0060"
label: "「무진당□」명 와"
labelHanja: "「戊辰當□」銘 瓦"
sourceKind: "금석문"
sourceGroup: "금석문 · 백제"
...
sourceLevelId: "gskh_002_0060_0030_0060"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_002_0060_0030_0060`. 경로: 백제 › 와명·전명 › 부여지역 출토 토기명 › 「무진당□」명 와.
...
XML 날짜: `0488-99-99` — 488년(동성왕10년) / 548년(성왕26년) / 608년(무왕9년).
...
출토·소재지 원표기: 충청남도 부여군 부여읍 쌍북리. 소장처: 없음.
크기: 없음. 서체: 흙.
[국편 항목](https://db.history.go.kr/id/gskh_002_0060_0030_0060)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 1. 연대(dateOccured) 붙은 chunk 0, 본문이 빈 chunk 0, 본문 글자 수 85.
주석 0(), 색인어 0().
<!-- counts:end -->
