---
type: "Source"
id: "src-geumseok-gskh_009_0060_0020_0950"
label: "영화9년명 전"
labelHanja: "永和九年銘 塼"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
...
sourceLevelId: "gskh_009_0060_0020_0950"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0060_0020_0950`. 경로: 낙랑 › 와명·전명·토기명 › 전명 › 영화9년명 전.
...
XML 날짜: `0353-99-99` — 353년(동진(東晉) 목제(穆帝) 영화(永和)9년).
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 평양시 평양역(平壤驛) 구내 전축분.
크기: 측면 35×5cm. 서체: 예서체(隷書體) / 흙.
[국편 항목](https://db.history.go.kr/id/gskh_009_0060_0020_0950)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,774.
주석 3(각주 3), 색인어 2(관직 1 · 이름 1).
<!-- counts:end -->
