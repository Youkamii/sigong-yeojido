---
type: "Source"
id: "src-geumseok-gskh_005_0010_0270"
label: "제천 월광사지 원랑선사탑비"
labelHanja: "堤川 月光寺址 圓朗禪師塔碑"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0010_0270"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0010_0270`. 경로: 통일신라 › 비문 › 제천 월광사지 원랑선사탑비.
...
출토·소재지 원표기: 國立中央博物館(原 忠北 堤川郡 寒水面 東倉里 月光寺址). 소장처: 없음.
크기: 碑身 높이 224cm、폭 97cm、글자크기 2.1cm. 서체: 楷書.
[국편 항목](https://db.history.go.kr/id/gskh_005_0010_0270)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 6. 연대(dateOccured) 붙은 chunk 3, 본문이 빈 chunk 0, 본문 글자 수 13,256.
주석 90(각주 88 · 소자쌍행 2), 색인어 92(이름 60 · 지명 25 · 관직 7).
<!-- counts:end -->
