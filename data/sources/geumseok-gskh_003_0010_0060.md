---
type: "Source"
id: "src-geumseok-gskh_003_0010_0060"
label: "단양 신라 적성비"
labelHanja: "丹陽 新羅 赤城碑"
sourceKind: "금석문"
sourceGroup: "금석문 · 신라"
composedYear: 550
coversFrom: 550
...
sourceLevelId: "gskh_003_0010_0060"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_003_0010_0060`. 경로: 신라 › 비문 › 단양 신라 적성비.
...
XML 날짜: `0550-99-99` — 551년(진흥왕 12), 545년(진흥왕 6) 이전, 550년(진흥왕 11).
...
출토·소재지 원표기: 충청북도 단양군 단성면 하방리 산3-1번지. 소장처: 충청북도 단양군 단성면 하방리 산3-1번지.
크기: 높이 93.0㎝, 너비 53.0~107.0㎝. 서체: 해서체이나 예서체도 가미.
[국편 항목](https://db.history.go.kr/id/gskh_003_0010_0060)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 4,091.
주석 97(각주 97), 색인어 0().
<!-- counts:end -->
