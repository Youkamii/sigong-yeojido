...
국사편찬위원회 실록원문 벌크 XML(2022-11-03)의 `wra` 계열 파일을 모은 판본이다.
원문 사료와 수정·보완본을 별도 Source로 둔다. 원문을 합치거나 옳고 그름을 정하지 않는다.

## 연도 근거

[국가기록원 실록 일람표](https://theme.archives.go.kr/next/sillok/sub2_2.do)의 수록 기간 1659~1674, 편찬 연도 1677를 따른다.
...
chunk 가 놓인 층: level2 18 · level3 193 · level5 9,291. 연대(dateOccured) 붙은 chunk 9,307, 본문이 빈 chunk 0, 본문 글자 수 1,421,369.
주석 472(교감주 315 · 원주 157), 색인어 45,975(이름 36,872 · 지명 8,298 · 서명 744 · 연호 61).
<!-- counts:end -->

숫자는 `scripts/fill_card_counts.py --source sillok-wra`와 같은 코드로 센다.
