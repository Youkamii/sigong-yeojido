---
type: "Source"
id: "src-geumseok-gskh_005_0030_0030"
label: "경주 표암 각석 명문"
labelHanja: "慶州 瓢巖 刻石 銘文)"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0030_0030"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0030_0030`. 경로: 통일신라 › 석각 › 경주 표암 각석 명문.
...
XML 날짜: `0743-99-99` — 743년(신라 경덕왕 2년).
...
출토·소재지 원표기: 경상북도 경주시 동천동 507-7번지. 소장처: 없음.
크기: (각석면) 가로 (230)㎝, 세로 (200)㎝. 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_005_0030_0030)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,199.
주석 2(각주 2), 색인어 0().
<!-- counts:end -->
