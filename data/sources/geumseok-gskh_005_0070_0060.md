---
type: "Source"
id: "src-geumseok-gskh_005_0070_0060"
label: "규흥사 종명"
labelHanja: "竅興寺 鐘銘"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0070_0060"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0070_0060`. 경로: 통일신라 › 종명·금구명 › 규흥사 종명.
...
XML 날짜: `0856-99-99` — 856년(신라 문성왕 18).
...
출토·소재지 원표기: 현존하지 않음. 소장처: 없음.
크기: 미상. 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_005_0070_0060)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 2,127.
주석 35(각주 35), 색인어 0().
<!-- counts:end -->
