...
국사편찬위원회 실록원문 벌크 XML(2022-11-03)의 `wnb` 계열 파일을 모은 판본이다.
원문 사료와 수정·보완본을 별도 Source로 둔다. 원문을 합치거나 옳고 그름을 정하지 않는다.

## 연도 근거

[국가기록원 실록 일람표](https://theme.archives.go.kr/next/sillok/sub2_2.do)의 수록 기간 1567~1608, 편찬 연도 1657를 따른다.
...
chunk 가 놓인 층: level2 44 · level3 439 · level5 1,867. 연대(dateOccured) 붙은 chunk 1,909, 본문이 빈 chunk 0, 본문 글자 수 608,091.
주석 527(원주 446 · 교감주 81), 색인어 22,338(이름 17,830 · 지명 3,985 · 서명 437 · 연호 86).
<!-- counts:end -->

숫자는 `scripts/fill_card_counts.py --source sillok-wnb`와 같은 코드로 센다.
