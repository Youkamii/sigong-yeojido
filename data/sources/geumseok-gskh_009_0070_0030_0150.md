---
type: "Source"
id: "src-geumseok-gskh_009_0070_0030_0150"
label: "정백동 2호분(고상현묘) 출토 칠기 명문"
labelHanja: "貞柏洞 2號墳(高常賢墓) 出土 漆器 銘文"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
composedYear: null
coversFrom: null
...
sourceLevelId: "gskh_009_0070_0030_0150"
defaultLens: false
license: "open"
...
# 정백동 2호분(고상현묘) 출토 칠기 명문

국편 한국고대금석문 벌크의 `gskh_009_0070_0030_0150`. 경로: 낙랑 › 칠기명 › 명문 칠기 › 정백동 2호분(고상현묘) 출토 칠기 명문.
...
출토·소재지 원표기: 북한. 소장처: 평양시 락랑구역(樂浪區域) 정백동(貞柏洞, 구 정백리) 2호분(고상현묘(高常賢墓)).
크기: 미상(未詳). 서체: 나무.
[국편 항목](https://db.history.go.kr/id/gskh_009_0070_0030_0150)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,079.
주석 2(각주 2), 색인어 1(이름 1).
<!-- counts:end -->
