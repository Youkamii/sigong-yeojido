---
type: "Source"
id: "src-geumseok-gskh_009_0070_0020_0300"
label: "시초원년명 칠반"
labelHanja: "初始元年銘 漆盤"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
...
sourceLevelId: "gskh_009_0070_0020_0300"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0070_0020_0300`. 경로: 낙랑 › 칠기명 › 기년명 칠기 › 시초원년명 칠반.
...
XML 날짜: `0008-99-99` — 8년(전한(前漢) 유자영(孺子瓔) 초시(初始)원년).
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 전(傳) 평양시 락랑구역(樂浪區域) 오야리(梧野里) 낙랑고분.
크기: 없음. 서체: 나무.
[국편 항목](https://db.history.go.kr/id/gskh_009_0070_0020_0300)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,139.
주석 5(각주 5), 색인어 11(이름 6 · 관직 4 · 관서 1).
<!-- counts:end -->
