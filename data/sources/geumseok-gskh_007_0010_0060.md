---
type: "Source"
id: "src-geumseok-gskh_007_0010_0060"
label: "고원망 묘지명"
labelHanja: "高遠望 墓誌銘"
sourceKind: "금석문"
...
sourceLevelId: "gskh_007_0010_0060"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_007_0010_0060`. 경로: 고구려 유민 관련 금석문 › 묘지명 › 고원망 묘지명.
...
XML 날짜: `0740-05-28` — 사망일 : 740년(開元 28년) 5월 28일; 장례일 : 745년(天寶 4년) 10월 13일.
...
출토·소재지 원표기: 中國 河南省 洛陽市 第二文物工作隊. 소장처: 中國 河南省 洛陽市 孟津縣 營庄.
크기: 지석(誌石) : 가로 70.0㎝, 세로 69.5㎝, 두께 15.0㎝; 개석(蓋石)의 존부 미확인. 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_007_0010_0060)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 5,169.
주석 19(각주 19), 색인어 0().
<!-- counts:end -->
