---
type: "Source"
id: "src-geumseok-gskh_009_0070_0030_0040"
label: "남정리 116호분(채협총) 출토 칠기 명문"
labelHanja: "南井里 116號墳(彩篋塚) 出土 漆器 銘文"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
composedYear: null
coversFrom: null
...
sourceLevelId: "gskh_009_0070_0030_0040"
defaultLens: false
license: "open"
...
# 남정리 116호분(채협총) 출토 칠기 명문

국편 한국고대금석문 벌크의 `gskh_009_0070_0030_0040`. 경로: 낙랑 › 칠기명 › 명문 칠기 › 남정리 116호분(채협총) 출토 칠기 명문.
...
크기: 미상(未詳). 서체: 나무.
[국편 항목](https://db.history.go.kr/id/gskh_009_0070_0030_0040)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,885.
주석 14(각주 14), 색인어 15(이름 11 · 관직 4).
<!-- counts:end -->
