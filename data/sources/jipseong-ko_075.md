...
국편 한국고대사료집성 중국편에 실린 『天台九祖傳』의 한국사 관련 발췌다.
사서 전체 원문을 수록한 것으로 표시하지 않는다. 국편 사서 id `ko_075`를 Source 이름에 쓴다.
...
chunk 가 놓인 층: level3 1. 연대(dateOccured) 붙은 chunk 0, 본문이 빈 chunk 0, 본문 글자 수 172.
주석 1(원주 1), 색인어 14(지명 7 · 이름 5 · 서명 1 · 연호 1).
<!-- counts:end -->
