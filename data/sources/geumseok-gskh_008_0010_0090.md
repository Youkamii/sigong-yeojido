---
type: "Source"
id: "src-geumseok-gskh_008_0010_0090"
label: "흑치상지 묘지명"
labelHanja: "黑齒常之 墓誌銘"
sourceKind: "금석문"
...
sourceLevelId: "gskh_008_0010_0090"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_008_0010_0090`. 경로: 백제 유민 관련 금석문 › 묘지명 › 흑치상지 묘지명.
...
XML 날짜: `0699-99-99` — 699년(주 측천무후 성력 2년).
...
출토·소재지 원표기: 중국 쟝쑤성(江蘇省) 난징시(南京市) 남경박물원(南京博物院). 소장처: 중국 허난성(河南省) 뤄양시(洛陽市) 북망산(北邙山).
크기: [지석] 가로 72㎝, 세로 71㎝. 서체: 해서.
[국편 항목](https://db.history.go.kr/id/gskh_008_0010_0090)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 13,266.
주석 113(각주 113), 색인어 0().
<!-- counts:end -->
