---
type: "Source"
id: "src-geumseok-gskh_003_0010_0120"
label: "임신서기석"
labelHanja: "壬申誓記石"
sourceKind: "금석문"
sourceGroup: "금석문 · 신라"
...
sourceLevelId: "gskh_003_0010_0120"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_003_0010_0120`. 경로: 신라 › 비문 › 임신서기석.
...
XML 날짜: `0552-99-99` — 552년(진흥왕 13) 또는 612년(진평왕 34).
...
출토·소재지 원표기: 경상북도 경주시 일정로 186(인왕동, 국립경주박물관). 소장처: 경상북도 경주시 금장리 석장사터 부근 언덕.
크기: 높이 34.0㎝, 너비 12.5㎝, 두께 2.0㎝. 서체: 해서체이나 예서체도 가미.
[국편 항목](https://db.history.go.kr/id/gskh_003_0010_0120)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 2,352.
주석 20(각주 20), 색인어 0().
<!-- counts:end -->
