---
type: "Source"
id: "src-geumseok-gskh_008_0010_0030"
label: "부여융 묘지명"
labelHanja: "扶餘隆 墓誌銘"
sourceKind: "금석문"
...
sourceLevelId: "gskh_008_0010_0030"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_008_0010_0030`. 경로: 백제 유민 관련 금석문 › 묘지명 › 부여융 묘지명.
...
XML 날짜: `0682-99-99` — 682년(당 고종 영순 원년) 이후.
...
출토·소재지 원표기: 중국 허난성(河南城) 카이펑도서관(開封圖書館). 소장처: 미상(중국 허난성(河南城) 뤄양시(洛陽市) 북망산(北邙山)).
크기: 너비 57.8cm, 높이 56.8cm. 서체: 해서 / 예서(일부).
[국편 항목](https://db.history.go.kr/id/gskh_008_0010_0030)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 7,425.
주석 130(각주 130), 색인어 0().
<!-- counts:end -->
