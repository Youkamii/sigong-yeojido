---
type: "Source"
id: "src-geumseok-gskh_003_0020_0080"
label: "제천 점말동굴 유적 각석 명문"
labelHanja: "堤川 점말洞窟 遺蹟 刻石 銘文"
sourceKind: "금석문"
sourceGroup: "금석문 · 신라"
composedYear: null
coversFrom: null
...
sourceLevelId: "gskh_003_0020_0080"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_003_0020_0080`. 경로: 신라 › 석각 › 제천 점말동굴 유적 각석 명문.
...
출토·소재지 원표기: 충청북도 제천시 송학면 포전리 산68-1번지. 소장처: 없음.
크기: 미상(未詳). 서체: 해서(楷書).
[국편 항목](https://db.history.go.kr/id/gskh_003_0020_0080)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 2,011.
주석 20(각주 20), 색인어 0().
<!-- counts:end -->
