---
type: "Source"
id: "src-geumseok-gskh_001_0030_0040"
label: "평양성 석각(3)"
labelHanja: "平壤城 石刻"
sourceKind: "금석문"
sourceGroup: "금석문 · 고구려"
...
sourceLevelId: "gskh_001_0030_0040"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_001_0030_0040`. 경로: 고구려 › 석각 › 평양성 석각(3).
...
출토·소재지 원표기: 미상(未詳). 소장처: 없음.
크기: 高1尺5寸、幅1尺7寸. 서체: 미상(未詳).
[국편 항목](https://db.history.go.kr/id/gskh_001_0030_0040)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 7. 연대(dateOccured) 붙은 chunk 4, 본문이 빈 chunk 0, 본문 글자 수 1,748.
주석 6(각주 6), 색인어 8(관직 4 · 이름 4).
<!-- counts:end -->
