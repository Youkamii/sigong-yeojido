---
type: "Source"
id: "src-geumseok-gskh_002_0040_0060"
label: "부여 부소산성 출토 금동광배 명문"
labelHanja: "扶餘 扶蘇山城 出土 金銅光背 銘文"
sourceKind: "금석문"
sourceGroup: "금석문 · 백제"
composedYear: null
coversFrom: null
...
sourceLevelId: "gskh_002_0040_0060"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_002_0040_0060`. 경로: 백제 › 불상명 › 부여 부소산성 출토 금동광배 명문.
...
출토·소재지 원표기: 충남 부여군 부여읍 부소로 31(쌍북리). 소장처: 없음.
크기: 지름 12.7㎝, 두께 1.8㎝. 서체: 해서(楷書), 행서(行書), 초서(草書).
[국편 항목](https://db.history.go.kr/id/gskh_002_0040_0060)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,170.
주석 2(각주 2), 색인어 0().
<!-- counts:end -->
