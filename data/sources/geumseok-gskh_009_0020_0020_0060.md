---
type: "Source"
id: "src-geumseok-gskh_009_0020_0020_0060"
label: "위지삼공명 내행화문경(2)"
labelHanja: "位至三公銘 內行花文鏡(2)"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
composedYear: null
coversFrom: null
...
sourceLevelId: "gskh_009_0020_0020_0060"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0020_0020_0060`. 경로: 낙랑 › 동경명 › 내행화문경 › 위지삼공명 내행화문경(2).
...
출토·소재지 원표기: 미상(舊 關口半氏藏). 소장처: 없음.
크기: 徑3寸 8分 5厘. 서체: 隷書.
[국편 항목](https://db.history.go.kr/id/gskh_009_0020_0020_0060)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 4. 연대(dateOccured) 붙은 chunk 2, 본문이 빈 chunk 0, 본문 글자 수 586.
주석 0(), 색인어 0().
<!-- counts:end -->
