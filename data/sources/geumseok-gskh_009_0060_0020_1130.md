---
type: "Source"
id: "src-geumseok-gskh_009_0060_0020_1130"
label: "태강9년명 전"
labelHanja: "太康九年銘 塼"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
...
sourceLevelId: "gskh_009_0060_0020_1130"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0060_0020_1130`. 경로: 낙랑 › 와명·전명·토기명 › 전명 › 태강9년명 전.
...
XML 날짜: `0288-99-99` — 288년(진(晉) 무제(武帝) 태강(太康)9년).
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 황해남도(구 황해도) 안악군(安岳郡) 용순면(龍順面) 유설리(柳雪里) 북동(北洞).
크기: 측면 38×5cm. 서체: 해서체(楷書體) / 흙.
[국편 항목](https://db.history.go.kr/id/gskh_009_0060_0020_1130)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,590.
주석 1(각주 1), 색인어 0().
<!-- counts:end -->
