---
type: "Source"
id: "src-geumseok-gskh_002_0060_0010_0100"
label: "「웅천」명 와"
labelHanja: "「熊川」銘 瓦"
sourceKind: "금석문"
sourceGroup: "금석문 · 백제"
...
sourceLevelId: "gskh_002_0060_0010_0100"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_002_0060_0010_0100`. 경로: 백제 › 와명·전명 › 공주지역 출토 와전명 › 「웅천」명 와.
...
출토·소재지 원표기: 국립공주박물관. 소장처: 충청남도 공주시 산성동(山城洞) 공산성(公山城) 및 충청남도 공주시 금성동(錦城洞) 정지산(艇止山) 등.
크기: 두께 1.8cm. 서체: 해서(楷書) / 흙.
[국편 항목](https://db.history.go.kr/id/gskh_002_0060_0010_0100)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 358.
주석 0(), 색인어 1(지명 1).
<!-- counts:end -->
