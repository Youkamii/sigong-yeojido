---
type: "Source"
id: "src-geumseok-gskh_005_0040_0050"
label: "경주 창림사 무구정탑지"
labelHanja: "慶州 昌林寺 無垢淨塔誌"
sourceKind: "금석문"
...
sourceLevelId: "gskh_005_0040_0050"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_005_0040_0050`. 경로: 통일신라 › 탑명·등명 › 경주 창림사 무구정탑지.
...
XML 날짜: `0855-99-99` — 855년(신라 문성왕 17년).
...
출토·소재지 원표기: 현존하지 않음(용주사 효행박물관?). 소장처: 경상북도 경주시 배동 창림사지.
크기: 가로 약 30㎝, 세로 약 25㎝(또는 가로 38.2㎝, 세로 22.4㎝). 서체: 해서(왕희지체 집자).
[국편 항목](https://db.history.go.kr/id/gskh_005_0040_0050)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level4 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 4,101.
주석 41(각주 39 · 소자쌍행 2), 색인어 0().
<!-- counts:end -->
