---
type: "Source"
id: "src-geumseok-gskh_009_0070_0020_0610"
label: "지절4년명 칠곽"
labelHanja: "地節四年銘 漆槨"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
...
sourceLevelId: "gskh_009_0070_0020_0610"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0070_0020_0610`. 경로: 낙랑 › 칠기명 › 기년명 칠기 › 지절4년명 칠곽.
...
XML 날짜: `9999-99-99` — BC66년(전한(前漢) 소제(昭帝) 지절(地節)4년).
...
출토·소재지 원표기: 북한. 소장처: 평양시 락랑구역(樂浪區域) 정백동(貞柏洞, 구 정백리) 37호분.
크기: 없음. 서체: 나무.
[국편 항목](https://db.history.go.kr/id/gskh_009_0070_0020_0610)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 3. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 1,092.
주석 1(각주 1), 색인어 0().
<!-- counts:end -->
