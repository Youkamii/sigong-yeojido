---
type: "Source"
id: "src-geumseok-gskh_009_0060_0020_1010"
label: "장무이명 전"
labelHanja: "張撫夷銘 塼"
sourceKind: "금석문"
sourceGroup: "금석문 · 낙랑"
...
sourceLevelId: "gskh_009_0060_0020_1010"
defaultLens: false
license: "open"
...
국편 한국고대금석문 벌크의 `gskh_009_0060_0020_1010`. 경로: 낙랑 › 와명·전명·토기명 › 전명 › 장무이명 전.
...
XML 날짜: `0348-99-99` — 348년(동진(東晉) 목제(穆帝) 영화(永和)4년).
...
출토·소재지 원표기: 국립중앙박물관. 소장처: 황해북도(구 황해도) 봉산군(鳳山郡) 문정면(文井面) 소봉리(昭封里) 1호분.
크기: 없음. 서체: 예서체(隷書體) / 흙.
[국편 항목](https://db.history.go.kr/id/gskh_009_0060_0020_1010)의 id를 연결 정보로 보존했다.
...
chunk 가 놓인 층: level5 4. 연대(dateOccured) 붙은 chunk 1, 본문이 빈 chunk 0, 본문 글자 수 2,431.
주석 8(각주 8), 색인어 25(관직 11 · 이름 10 · 지명 4).
<!-- counts:end -->
