...
| Q10 | 이 지역의 설화는 어떤 인물·장소·문헌과 이어지며, 이야기 속 시기와 문헌의 시기는 어떻게 다른가 | Narrative + 무대·등장인물·문헌 Claim |

이 질문들이 클래스 목록을 정당화한다. 질문 없이 클래스를 늘리지 않는다.
...
| `syj:Event` | 사건 | 껍데기 |
| `syj:Narrative` | 설화·구전·전승 | 껍데기. 실제 사건 Event와 구분 |
