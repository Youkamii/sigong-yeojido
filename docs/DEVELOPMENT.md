...
> 사용자용 소개는 저장소 루트의 [README.md](../README.md)에 있다. 이 문서는 2026-09-16까지 README에 있던 데이터 현황·구조·실행·검증·작업 규약을 그대로 옮긴 것이다. 최신 진행 상황은 [HANDOVER.md](HANDOVER.md)와 [TASKS.md](TASKS.md)를 따른다.
...
- 원칙과 그림: `00-vision.md`
- 사료 목록·라이선스: `01-sources.md`, 사료 카드 `data/sources/*.md`
- 스키마 정본(3층: 엔티티 / Claim / Source·chunk): `02-schema.md`
- 조사 기록(사료 조사 1·2차, codex 교차검증, 국편 벌크 XML 구조): `research/`
- 현재 운영 상태·완료 이슈·다음 작업: [인수인계](HANDOVER.md)
- 전체 요구사항·완료 범위·빠진 기능: [전체 작업 목록](TASKS.md)
...
전체 작업과 미검증 범위는 [TASKS.md](TASKS.md)를 따른다.

## 이전 데이터 스냅샷 (2026-09-07)

| 사료 묶음 | Source | chunk | 재현·검증 |
|---|---:|---:|---|
| 광개토왕릉비·삼국사기·삼국유사·고려사 | 4 | 37,003 | [사료 목록](01-sources.md) |
| 조선왕조실록 | 30 | 389,483 | [실록 적재](research/sillok-ingestion.md) |
| 한국고대금석문 | 823 | 3,195 | [금석문 적재](research/geumseokmun-ingestion.md) |
| 한국고대사료집성 | 92 | 8,689 | [집성 적재](research/jipseong-ingestion.md) |
| 단군 표기 설명(백과사전 짧은 인용) | 1 | 1 | [사료 카드](../data/sources/encykorea-dangun.md) |
| 승정원일기 | 1 | 2,001,115 | [승정원일기 적재](research/seungjeongwon-ilgi-ingestion.md) |
| 비변사등록 | 1 | 93,801 | [비변사등록 적재](research/bibyeonsa-deungnok-ingestion.md) |
| 고종실록·순종실록·순종실록부록 | 3 | 33,633 | [고순종실록 적재](research/gosunjong-sillok-ingestion.md) |
| 추가 위치·인물·연대·근현대 발췌·역사 경계 | 44 | 837 | [전체 작업·근거](TASKS.md) |
| 고려사절요 | 1 | 11,226 | [35권·소개와 원 XML 대조](research/goryeosa-jeolyo-76.md) |
| 한국독립운동사자료 42권 | 42 | 13,366 | [kd036 결손·빈 항목 보존](research/independence-77.md) |
| 고운당필기 | 1 | 255 | [254기사·범례](research/itkc-gowundang-78.md) |
| 위키문헌 고전 전사 6종 | 6 | 113 | [실제 HTML·저본·결손](research/wikisource-corpus-80.md) |
| HGIS 읍·면 등(기존 Source 확장) | 0 | 8,176 | [원 기간·도형·반복 대조](research/hgis-townships-75.md) |
| Cliopatria 한국사 국가 경계 | 1 | 94 | [원 기록·기간·표시 한계](research/cliopatria-79.md) |
| 시대별 해설·평양 견해·사건 장소 | 22 | 43 | [시대별 범위](research/claim-periods-51.md) |
| 경국대전 1934년판 원해상도 스캔 | 1 | 319 | [319코마·전사문 0](research/ndl-scan-87.md) |
| 현재 대관령옛길·별도 기관 설명 | 2 | 2 | [932점의 현재 코스·과거 노선 미확인](research/preserved-route-88.md) |
| **c2 합계** | **1,075** | **2,601,351** | [운영 기록](research/preserved-route-deployed-88.json) |
...
독립신문(서재필) 19,635기사는 추출·검사 후 c2의 별도 작업 폴더에 보관했다. 공개 적재 조건 확인이 남아 위 표와 공개 뷰어에는 포함하지 않았다. [수집 상태](research/newspaper-lod-90.md).
...
전체 적재본이 있으면 모든 필드가 같은지 대조하고 한 번만 센다. [실제 새 복사본 검사](research/goal-clean-clone.json)
...
2026-09-09 전체 데이터의 c2 뷰어 준비는 약8분, 준비 후 RSS약3.3GiB였다. 기존 뷰어를 유지한 채 준비용 뷰어의 전체 색인을 올리다가 OOM 종료가 발생했다. 지금은 뷰어 하나로 복구했고, 두 전체 색인을 겹쳐 기동하지 않는다. [복구·실행 근거](research/runtime-recovery-137.md). 원문을 디스크에서 필요한 만큼 읽는 구조 개선은 #139에 남아 있다.
API 준비를 확인한 뒤 접속한다. 검증·TTL 빌더는 인용된 원문만 읽어 최대 RSS 약 558 MiB로 전체 자료를 처리했다.
이는 해당 실행의 관측값이다. [측정 기록](research/chunk-index-memory.md)
...
- 현재 옛길: `verify_preserved_route.py` — 실제 932점·2D/3D·두 근거·기간/사료/AI·480px 검사. [범위](research/preserved-route-88.md).
- 스캔 열람: `verify_ndl_scan.py` — 원 스캔 319장 해시·실제 API·면 이동·사료 해제/복구·480px 검사 5개. [현재 외부 주소 검사](research/ndl-scan-87-production.json).
- [실제 c2 운영 수용](research/goal-production-acceptance.json), [이름·인용 수정 검사](research/name-quotes-production-84-85.json), [역로 표시의 인공 시험 범위](research/route-rendering-86.md). Python 111개·JavaScript 14개와 전체 TTL 검사 통과, GitHub Actions·별도 riot는 NOT_RUN.
