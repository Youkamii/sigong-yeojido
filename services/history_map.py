...
CATALOGS={0:'cliopatria-korea-v013',1:'hgis-provinces-1910-1945',2:'hgis-districts-1910-1945',3:'hgis-townships-1883-1945',4:'khs-events'}
...
def historical_features(data,sources=None,origin='all',year=None,level=1):
    ...
    level=int(level)
    if level not in CATALOGS:raise ValueError('level must be 0 (polity), 1 (province), 2 (district), 3 (township) or 4 (event site)')
