...
const periods=[
  ...
  {until:1955,id:'postwar',year:1950,housing:'traditional',fields:true,people:'field_worker',tigers:false},
  {until:1970,id:'modern-farming',year:1960,housing:'traditional',fields:true,people:'field_worker',tigers:false},
  {until:1973,id:'early-roof-transition',year:1970,housing:'mixed',fields:true,people:'field_worker',tigers:false},
...
export function sceneryRecipe(recipe,period,site){
  ...
  if(houses.includes(archetype)){
    ...
    else if(['mixed','modern'].includes(period.housing)){
    ...
    archetype=buildingArchetype(archetype,period.year,{seed:choice});
