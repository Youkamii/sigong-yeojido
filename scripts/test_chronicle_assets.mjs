...
assert.equal(catalog.blueprintCount,34);
...
for(const archetype of ['human','scribe','monk','battle','hanging_scroll','ship','wall','table','book','handcart','steelworks','station','train','car','motor_ship','civic_hall','rocket','rifle_soldier']){
